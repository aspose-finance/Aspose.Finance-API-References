...
description: Aspose.Finance.Xbrl.DefinitionLinkbaseRef कक्ष. इस वर्ग क उपयग लंकबेस संदर्भ क परभषत करने के लए कय जत है
type: docs
weight: 6640
url: /hi/net/aspose.finance.xbrl/definitionlinkbaseref/
---
## DefinitionLinkbaseRef class

इस वर्ग का उपयोग लिंकबेस संदर्भ को परिभाषित करने के लिए किया जाता है।
...
| [Links](../../aspose.finance.xbrl/definitionlinkbaseref/links/) { get; } | का संग्रह प्राप्त करता है[`DefinitionLink`](../definitionlink/) . |
