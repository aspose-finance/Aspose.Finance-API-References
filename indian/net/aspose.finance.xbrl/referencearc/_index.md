...
description: Aspose.Finance.Xbrl.ReferenceArc कक्ष. यह वर्ग एक हैXlink चप प्रकर के सथ. यह अवधरणओं क संदर्भ संसधनं से जड़त है.
type: docs
weight: 7960
url: /hi/net/aspose.finance.xbrl/referencearc/
---
## ReferenceArc class

यह वर्ग एक है[`Xlink`](../xlink/) चाप प्रकार के साथ. यह अवधारणाओं को संदर्भ संसाधनों से जोड़ता है.
...
| नाम | विवरण |
| --- | --- |
| [GetFromLocs](../../aspose.finance.xbrl/referencearc/getfromlocs/)() | से का संग्रह प्राप्त करता है[`Loc`](../loc/) में`ReferenceArc` . |
| [GetToRefereces](../../aspose.finance.xbrl/referencearc/gettorefereces/)() | का संग्रह प्राप्त करता है[`Reference`](../reference/) में`ReferenceArc` . |
