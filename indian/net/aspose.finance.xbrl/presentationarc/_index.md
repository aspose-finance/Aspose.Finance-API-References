---
title: Class PresentationArc
second_title: Aspose.Finance for .NET API Reference
description: Aspose.Finance.Xbrl.PresentationArc कक्ष. यह वर्ग एक हैXlinkचप प्रकर के सथ. यह परभषत करत है क प्रस्तुत के लए अवधरणएं एक दूसरे से कैसे संबंधत हैं.
type: docs
weight: 7910
url: /hi/net/aspose.finance.xbrl/presentationarc/
---
## PresentationArc class

यह वर्ग एक है[`Xlink`](../xlink/)चाप प्रकार के साथ. यह परिभाषित करता है कि प्रस्तुति के लिए अवधारणाएं एक दूसरे से कैसे संबंधित हैं.
...
| [PreferredLabel](../../aspose.finance.xbrl/presentationarc/preferredlabel/) { get; set; } | पसंदीदा लेबल URI प्राप्त या सेट करता है. |
...
| नाम | विवरण |
| --- | --- |
| [GetFromLocs](../../aspose.finance.xbrl/presentationarc/getfromlocs/)() | से का संग्रह प्राप्त करता है[`Loc`](../loc/) में`PresentationArc` . |
| [GetToLocs](../../aspose.finance.xbrl/presentationarc/gettolocs/)() | का संग्रह प्राप्त करता है[`Loc`](../loc/) में`PresentationArc` . |
