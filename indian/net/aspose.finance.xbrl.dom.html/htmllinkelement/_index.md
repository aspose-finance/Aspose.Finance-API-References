...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLinkElement कक्ष. वर्ग एक बहर संसधन के लए एक लंक नर्दष्ट करत है और उस संसधन य इसके वपरत के लए इस दस्तवेज़ के संबंध क परभषत करत है HTML 4.01 में लंक तत्व क परभष देखें
type: docs
weight: 7030
url: /hi/net/aspose.finance.xbrl.dom.html/htmllinkelement/
---
## HTMLLinkElement class

वर्ग एक बाहरी संसाधन के लिए एक लिंक निर्दिष्ट करता है, और उस संसाधन (या इसके विपरीत) के लिए इस दस्तावेज़ के संबंध को परिभाषित करता है। HTML 4.01 में लिंक तत्व की परिभाषा देखें
