...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLScriptElement कक्ष. वर्ग स्क्रप्ट स्टेटमेंट क प्रतनधत्व करत है HTML 4.01 में SCRIPT एलमेंट क परभष देखें
type: docs
weight: 7170
url: /hi/net/aspose.finance.xbrl.dom.html/htmlscriptelement/
---
## HTMLScriptElement class

वर्ग स्क्रिप्ट स्टेटमेंट का प्रतिनिधित्व करता है। HTML 4.01 में SCRIPT एलिमेंट की परिभाषा देखें।
