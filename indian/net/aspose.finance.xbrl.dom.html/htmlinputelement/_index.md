...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLInputElement कक्ष. वर्ग प्रपत्र नयंत्रण क प्रतनधत्व करत है जस वतवरण में पृष्ठ देख ज रह है उस पर नर्भर करते हुए फ़इल अपलड इनपुट प्रकर के लए मूल्य संपत्त केवल पढ़ने के लए ह सकत है पसवर्ड इनपुट प्रकर के लए अनधकृत उपयग क रकने के लए लटए गए वस्तवक मन क मस्क कय ज सकत है HTML 4.01 में INPUT एलमेंट क परभष देखें
type: docs
weight: 6980
url: /hi/net/aspose.finance.xbrl.dom.html/htmlinputelement/
---
## HTMLInputElement class

वर्ग प्रपत्र नियंत्रण का प्रतिनिधित्व करता है। जिस वातावरण में पृष्ठ देखा जा रहा है, उस पर निर्भर करते हुए, फ़ाइल अपलोड इनपुट प्रकार के लिए मूल्य संपत्ति केवल पढ़ने के लिए हो सकती है। "पासवर्ड" इनपुट प्रकार के लिए, अनधिकृत उपयोग को रोकने के लिए लौटाए गए वास्तविक मान को मास्क किया जा सकता है। HTML 4.01 में INPUT एलिमेंट की परिभाषा देखें।
