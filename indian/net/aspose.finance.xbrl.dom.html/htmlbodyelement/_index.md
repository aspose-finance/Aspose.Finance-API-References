...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBodyElement कक्ष. वर्ग HTML दस्तवेज़ नकय क प्रतनधत्व करत है यह तत्व हमेश DOM API में मजूद हत है भले ह स्रत दस्तवेज़ में टैग मजूद न हं HTML 4.01 में बड एलमेंट क परभष देखें
type: docs
weight: 6790
url: /hi/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

वर्ग HTML दस्तावेज़ निकाय का प्रतिनिधित्व करता है। यह तत्व हमेशा DOM API में मौजूद होता है, भले ही स्रोत दस्तावेज़ में टैग मौजूद न हों। HTML 4.01 में बॉडी एलिमेंट की परिभाषा देखें।
