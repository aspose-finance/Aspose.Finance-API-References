...
description: Aspose.Finance.Xbrl.Dom.ProcessingInstruction कक्ष. वर्ग एक प्रसंस्करण नर्देश क प्रतनधत्व करत है जसक उपयग XML में दस्तवेज़ के पठ में प्रसेसरवशष्ट जनकर रखने के तरके के रूप में कय जत है
type: docs
weight: 7480
url: /hi/net/aspose.finance.xbrl.dom/processinginstruction/
---
## ProcessingInstruction class

वर्ग एक "प्रसंस्करण निर्देश" का प्रतिनिधित्व करता है, जिसका उपयोग XML में दस्तावेज़ के पाठ में प्रोसेसर-विशिष्ट जानकारी रखने के तरीके के रूप में किया जाता है।
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename/) { get; } | इस प्रसंस्करण निर्देश का नाम प्राप्त करता है। |
