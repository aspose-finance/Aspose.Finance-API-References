...
description: La classe représente une instruction de traitement utilisée en XML comme moyen de conserver des informations spécifiques au processeur dans le texte du document.
type: docs
weight: 7450
url: /fr/net/aspose.finance.xbrl.dom/processinginstruction/
---
## ProcessingInstruction class

La classe représente une "instruction de traitement", utilisée en XML comme moyen de conserver des informations spécifiques au processeur dans le texte du document.
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename) { get; } | Obtient le nom de cette instruction de traitement. |
