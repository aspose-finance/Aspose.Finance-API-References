...
description: 该类表示 Q 和 BLOCKQUOTE 元素。请参阅 HTML 4.01 中的 Q 元素定义。
type: docs
weight: 7160
url: /zh/net/aspose.finance.xbrl.dom.html/htmlquoteelement/
---
## HTMLQuoteElement class

该类表示 Q 和 BLOCKQUOTE 元素。请参阅 HTML 4.01 中的 Q 元素定义。
