...
description: 该类表示 HTML 文档正文此元素始终存在于 DOM API 中即使源文档中不存在标记请参阅 HTML 4.01 中的 BODY 元素定义
type: docs
weight: 6760
...
该类表示 HTML 文档正文。此元素始终存在于 DOM API 中，即使源文档中不存在标记。请参阅 HTML 4.01 中的 BODY 元素定义。
