...
description: 类表示选择元素允许选择一个选项包含的选项可以通过 select 元素作为集合直接访问请参阅 HTML 4.01 中的 SELECT 元素定义
type: docs
weight: 7150
...
类表示选择元素，允许选择一个选项。包含的选项可以通过 select 元素作为集合直接访问。请参阅 HTML 4.01 中的 SELECT 元素定义。
