...
| 名称 | 描述 |
| --- | --- |
| [WireTransferMessageSetV1](wiretransfermessagesetv1)() | 初始化一个 [`WireTransferMessageSetV1`](../wiretransfermessagesetv1) 类的新实例。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [CanScheduled](../../aspose.finance.ofx.profile/wiretransfermessagesetv1/canscheduled) { get; set; } | 获取或设置是否支持计划转账。 |
...
| [ProcessingDaysOffs](../../aspose.finance.ofx.profile/wiretransfermessagesetv1/processingdaysoffs) { get; set; } | 获取或设置一周中不进行处理的天数。 |
