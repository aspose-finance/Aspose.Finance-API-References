...
description: 这个类是一个Xlink./xlink弧形类型 它定义了概念如何相互关联以进行计算
type: docs
weight: 6500
...
这个类是一个[`Xlink`](../xlink)弧形类型。 它定义了概念如何相互关联以进行计算。
...
| 姓名 | 描述 |
| --- | --- |
| [GetFromLocs](../../aspose.finance.xbrl/calculationarc/getfromlocs)() | 获取 from 的集合[`Loc`](../loc)在里面[`CalculationArc`](../calculationarc). |
| [GetToLocs](../../aspose.finance.xbrl/calculationarc/gettolocs)() | 获取 to 的集合[`Loc`](../loc)在里面[`CalculationArc`](../calculationarc). |
