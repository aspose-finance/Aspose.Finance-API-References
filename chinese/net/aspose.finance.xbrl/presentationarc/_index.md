...
description: 这个类是一个Xlink./xlink弧形类型 它定义了概念如何相互关联以进行演示
type: docs
weight: 7860
...
这个类是一个[`Xlink`](../xlink)弧形类型。 它定义了概念如何相互关联以进行演示。
...
| 姓名 | 描述 |
| --- | --- |
| [GetFromLocs](../../aspose.finance.xbrl/presentationarc/getfromlocs)() | 获取 from 的集合[`Loc`](../loc)在里面[`PresentationArc`](../presentationarc). |
| [GetToLocs](../../aspose.finance.xbrl/presentationarc/gettolocs)() | 获取 to 的集合[`Loc`](../loc)在里面[`PresentationArc`](../presentationarc). |
