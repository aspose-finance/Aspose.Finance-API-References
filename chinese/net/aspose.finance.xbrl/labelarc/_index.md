...
description: 这个类是一个Xlink./xlink弧形类型. 将概念与Label./label资源.
type: docs
weight: 7780
...
这个类是一个[`Xlink`](../xlink)弧形类型. 将概念与[`Label`](../label)资源.
...
| 姓名 | 描述 |
| --- | --- |
| [GetFromLocs](../../aspose.finance.xbrl/labelarc/getfromlocs)() | 获取 from 的集合[`Loc`](../loc)在里面[`LabelArc`](../labelarc). |
| [GetToLabels](../../aspose.finance.xbrl/labelarc/gettolabels)() | 获取 to 的集合[`Label`](../label)在里面[`LabelArc`](../labelarc). |
