...
description: 这个类是一个Xlink./xlink与 Arc 类型 它将概念与Label./label资源连接起来
type: docs
weight: 7780
...
这个类是一个[`Xlink`](../xlink)与 Arc 类型。 它将概念与[`Label`](../label)资源连接起来。
...
| 姓名 | 描述 |
| --- | --- |
| [GetFromLocs](../../aspose.finance.xbrl/labelarc/getfromlocs)() | 从[`LabelArc`](../labelarc)中的[`Loc`](../loc)获取集合。 |
| [GetToLabels](../../aspose.finance.xbrl/labelarc/gettolabels)() | 在[`LabelArc`](../labelarc)中获取[`Label`](../label)的集合。 |
