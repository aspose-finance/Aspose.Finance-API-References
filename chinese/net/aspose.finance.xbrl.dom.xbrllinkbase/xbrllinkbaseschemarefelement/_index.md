...
description: 类表示 xbrl linkbase schemaRef 元素
type: docs
weight: 7580
...
类表示 xbrl linkbase schemaRef 元素。
...
* 命名空间 [Aspose.Finance.Xbrl.Dom.XbrlLinkbase](../../aspose.finance.xbrl.dom.xbrllinkbase)
* 部件 [Aspose.Finance](../../)
