...
description: 该类表示 xbrl linkbase schemaRef 元素。
type: docs
weight: 7610
url: /zh/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaseschemarefelement/
---
## XbrlLinkbaseSchemaRefElement class

该类表示 xbrl linkbase schemaRef 元素。
