...
description: 该类表示 xbrl linkbase linkbaseRef 元素。
type: docs
weight: 7590
url: /zh/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaselinkbaserefelement/
---
## XbrlLinkbaseLinkbaseRefElement class

该类表示 xbrl linkbase linkbaseRef 元素。
