...
| 名称 | 描述 |
| --- | --- |
| [IncludeImages](../../aspose.finance.ofx.email/mailsyncrequest/includeimages) { get; set; } | 如果客户端接受邮件正文中的图片则为 True，如果客户端不接受邮件正文中的图片则为 False |
...
| [UseHtml](../../aspose.finance.ofx.email/mailsyncrequest/usehtml) { get; set; } | 如果客户端想要 HTML 响应则为 True，如果客户端想要纯文本则为 False |
