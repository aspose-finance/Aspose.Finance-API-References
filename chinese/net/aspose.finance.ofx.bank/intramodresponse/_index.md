...
| 名称 | 描述 |
| --- | --- |
| [IntraModResponse](intramodresponse)() | 初始化一个新的 [`IntraModResponse`](../intramodresponse) 类实例。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [ServerId](../../aspose.finance.ofx.bank/intramodresponse/serverid) { get; set; } | 获取或设置服务器分配给正在修改的转账的 ID。 |
