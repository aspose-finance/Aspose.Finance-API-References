...
| 名称 | 描述 |
| --- | --- |
| [RecurringIntraTransactionRequest](recurringintratransactionrequest)() | 初始化一个新的 [`RecurringIntraTransactionRequest`](../recurringintratransactionrequest) 类实例。 |
