...
支票邮件通知消息响应类。如果服务器收到银行电子邮件同步消息，则在支票被退回时返回此响应。
...
| [CheckNumber](../../aspose.finance.ofx.bank/checkmailresponse/checknumber) { get; set; } | 获取或设置支票号码。 |
| [Fee](../../aspose.finance.ofx.bank/checkmailresponse/fee) { get; set; } | 获取或设置因非充足资金（NSF）收取的费用。 |
...
| [UserDate](../../aspose.finance.ofx.bank/checkmailresponse/userdate) { get; set; } | 获取或设置支票上的客户日期。 |
