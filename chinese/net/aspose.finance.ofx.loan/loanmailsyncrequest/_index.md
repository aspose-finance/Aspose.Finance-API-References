...
| 名称 | 描述 |
| --- | --- |
| [IncludeImages](../../aspose.finance.ofx.loan/loanmailsyncrequest/includeimages) { get; set; } | 如果客户端接受邮件正文中带有图像，则为 Yes；如果客户端不接受邮件正文中带有图像，则为 No。 |
...
| [UseHtml](../../aspose.finance.ofx.loan/loanmailsyncrequest/usehtml) { get; set; } | 如果客户端需要 HTML 响应，则为 Yes；如果客户端需要纯文本，则为 No。 |
