...
| [OriginCurrency](../../aspose.finance.ofx.investment/returnofcapital/origincurrency) { get; set; } | 获取或设置来源 [`Currency`](./currency)。 |
| [SecurityId](../../aspose.finance.ofx.investment/returnofcapital/securityid) { get; set; } | 获取或设置 [`SecurityId`](./securityid)。 |
| [SubAccountFund](../../aspose.finance.ofx.investment/returnofcapital/subaccountfund) { get; set; } | 获取或设置交易资金的来源或去向。 |
