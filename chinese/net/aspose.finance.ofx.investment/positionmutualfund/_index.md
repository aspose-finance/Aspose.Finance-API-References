...
| [UnitsStreet](../../aspose.finance.ofx.investment/positionmutualfund/unitsstreet) { get; set; } | 获取或设置 FI 的街道名称中的单位。 |
| [UnitsUser](../../aspose.finance.ofx.investment/positionmutualfund/unitsuser) { get; set; } | 获取或直接设置用户名称中的单位。 |
