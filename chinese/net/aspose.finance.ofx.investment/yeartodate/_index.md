...
| [EndDate](../../aspose.finance.ofx.investment/yeartodate/enddate) { get; set; } | 获取或设置本年度累计信息的结束日期。 |
| [StartDate](../../aspose.finance.ofx.investment/yeartodate/startdate) { get; set; } | 获取或设置本日历年的开始日期。 |
