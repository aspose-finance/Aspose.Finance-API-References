...
| [OriginCurrency](../../aspose.finance.ofx.investment/margininterest/origincurrency) { get; set; } | 获取或设置来源 [`Currency`](./currency)。 |
| [SubAccountFund](../../aspose.finance.ofx.investment/margininterest/subaccountfund) { get; set; } | 获取或设置交易资金的来源或去向。 |
