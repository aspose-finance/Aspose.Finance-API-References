...
| [InvestmentTransactions](../../aspose.finance.ofx.investment/investmenttransactionlist/investmenttransactions) { get; set; } | 获取或设置 [`BuyDebt`](../buydebt) 或 [`BuyMutualFund`](../buymutualfund) 或 [`BuyOption`](../buyoption) 或 [`BuyOther`](../buyother) 或 [`BuyStock`](../buystock) 或 [`ClosureOption`](../closureoption) 或 [`Income`](../income) 或 [`InvestmentExpense`](../investmentexpense) 或 [`JournalFund`](../journalfund) 或 [`JournalSecurity`](../journalsecurity) 或 [`MarginInterest`](../margininterest) 或 [`Reinvest`](../reinvest) 或 [`ReturnOfCapital`](../returnofcapital) 或 [`SellDebt`](../selldebt) 或 [`SellMutualFund`](../sellmutualfund) 或 [`SellOption`](../selloption) 或 [`SellOther`](../sellother) 或 [`SellStock`](../sellstock) 或 [`Split`](../split) 或 [`Transfer`](../transfer) 的集合。 |
