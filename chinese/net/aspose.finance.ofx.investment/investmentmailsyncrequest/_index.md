...
| 名称 | 描述 |
| --- | --- |
| [IncludeImages](../../aspose.finance.ofx.investment/investmentmailsyncrequest/includeimages) { get; set; } | 如果客户端接受邮件正文中的图片，则为 True；如果客户端不接受邮件正文中的图片，则为 False。 |
...
| [UseHtml](../../aspose.finance.ofx.investment/investmentmailsyncrequest/usehtml) { get; set; } | 如果客户端想要 HTML 响应，则为 True；如果客户端想要纯文本，则为 false。 |
