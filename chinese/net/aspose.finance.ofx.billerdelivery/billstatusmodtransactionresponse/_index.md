...
| 名称 | 描述 |
| --- | --- |
| [BillStatusModTransactionResponse](billstatusmodtransactionresponse)() | 初始化一个新的 [`BillStatusModTransactionResponse`](../billstatusmodtransactionresponse) 类实例。 |
