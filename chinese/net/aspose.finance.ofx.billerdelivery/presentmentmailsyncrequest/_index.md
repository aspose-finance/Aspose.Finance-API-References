...
| 名称 | 描述 |
| --- | --- |
| [IncludeImages](../../aspose.finance.ofx.billerdelivery/presentmentmailsyncrequest/includeimages) { get; set; } | 如果客户端接受邮件正文中的图片，则为 True；如果客户端不接受邮件正文中的图片，则为 False。 |
...
| [UseHtml](../../aspose.finance.ofx.billerdelivery/presentmentmailsyncrequest/usehtml) { get; set; } | 如果客户端想要 HTML 响应则为 True，如果客户端想要纯文本则为 False |
