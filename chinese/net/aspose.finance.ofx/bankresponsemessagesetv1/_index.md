...
description: "Bank response messages set version 1 类。"
type: docs
weight: 810
...
Bank response messages set version 1 类。
...
| 名称 | 描述 |
| --- | --- |
| [BankResponseMessageSetV1](bankresponsemessagesetv1)() | 初始化一个新的 [`BankResponseMessageSetV1`](../bankresponsemessagesetv1) 类实例。 |
