...
Email response messages set version 1 类。
...
| 名称 | 描述 |
| --- | --- |
| [EmailResponseMessageSetV1](emailresponsemessagesetv1)() | 初始化一个新的[`EmailResponseMessageSetV1`](../emailresponsemessagesetv1)类实例。 |
