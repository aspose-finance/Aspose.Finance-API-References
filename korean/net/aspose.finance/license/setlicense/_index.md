...
type: docs
weight: 20
url: /ko/net/aspose.finance/license/setlicense/
---
...
2. Java 애플리케이션의 현재 작업 디렉토리.

3. Aspose 컴포넌트 JAR 파일이 포함된 폴더.

4. 클라이언트의 호출 JAR 파일이 포함된 폴더.
