...
description: Aspose.Finance.Xbrl.LinkbaseRef 수업. 이 클래스는 링크베이스 참조에 사용됩니다.
type: docs
weight: 7850
url: /ko/net/aspose.finance.xbrl/linkbaseref/
---
## LinkbaseRef class

이 클래스는 링크베이스 참조에 사용됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [LinkbaseRef](linkbaseref/)() | 의 새 인스턴스를 초기화합니다.`LinkbaseRef` 클래스. |
