...
description: PresentationArc 방법. 에서 컬렉션을 가져옵니다.Loc 에서PresentationArc .
type: docs
weight: 20
url: /ko/net/aspose.finance.xbrl/presentationarc/getfromlocs/
---
## PresentationArc.GetFromLocs method

에서 컬렉션을 가져옵니다.[`Loc`](../../loc/) 에서[`PresentationArc`](../) .
