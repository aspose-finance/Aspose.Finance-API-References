...
description: Aspose.Finance.Xbrl.CalculationLinkbaseRef 수업. 이 클래스는 링크베이스 참조를 계산하는 데 사용됩니다.
type: docs
weight: 6550
url: /ko/net/aspose.finance.xbrl/calculationlinkbaseref/
---
## CalculationLinkbaseRef class

이 클래스는 링크베이스 참조를 계산하는 데 사용됩니다.
...
| [Links](../../aspose.finance.xbrl/calculationlinkbaseref/links/) { get; } | 컬렉션을 가져옵니다.[`CalculationLink`](../calculationlink/) . |
