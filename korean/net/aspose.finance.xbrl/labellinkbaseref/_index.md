...
description: Aspose.Finance.Xbrl.LabelLinkbaseRef 수업. 이 클래스는 linkbase 참조에 레이블을 지정하는 데 사용됩니다.
type: docs
weight: 7840
url: /ko/net/aspose.finance.xbrl/labellinkbaseref/
---
## LabelLinkbaseRef class

이 클래스는 linkbase 참조에 레이블을 지정하는 데 사용됩니다.
...
| [Links](../../aspose.finance.xbrl/labellinkbaseref/links/) { get; } | 컬렉션을 가져옵니다.[`LabelLink`](../labellink/) . |
