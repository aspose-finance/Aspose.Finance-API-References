...
description: Aspose.Finance.Xbrl.PresentationLinkbaseRef 수업. 이 클래스는 linkbase 참조를 표시하는 데 사용됩니다.
type: docs
weight: 7930
url: /ko/net/aspose.finance.xbrl/presentationlinkbaseref/
---
## PresentationLinkbaseRef class

이 클래스는 linkbase 참조를 표시하는 데 사용됩니다.
...
| [Links](../../aspose.finance.xbrl/presentationlinkbaseref/links/) { get; } | 컬렉션을 가져옵니다.[`PresentationLink`](../presentationlink/) . |
