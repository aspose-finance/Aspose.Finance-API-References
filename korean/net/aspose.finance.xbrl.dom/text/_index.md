...
description: Aspose.Finance.Xbrl.Dom.Text 수업. 클래스는 텍스트 콘텐츠를 나타냅니다.
type: docs
weight: 7490
url: /ko/net/aspose.finance.xbrl.dom/text/
---
## Text class
...
| override [NodeName](../../aspose.finance.xbrl.dom/text/nodename/) { get; } | 이 텍스트의 이름을 가져옵니다. |
