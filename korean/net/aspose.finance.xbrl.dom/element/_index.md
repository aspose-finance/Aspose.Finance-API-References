...
description: Aspose.Finance.Xbrl.Dom.Element 수업. 요소 인터페이스는 인라인 xbrl 문서의 요소를 나타냅니다.
type: docs
weight: 6700
url: /ko/net/aspose.finance.xbrl.dom/element/
---
## Element class

요소 인터페이스는 인라인 xbrl 문서의 요소를 나타냅니다.
