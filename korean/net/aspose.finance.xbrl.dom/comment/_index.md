...
description: Aspose.Finance.Xbrl.Dom.Comment 수업. CharacterData에서 상속되고 주석의 내용을 나타냅니다.
type: docs
weight: 6680
url: /ko/net/aspose.finance.xbrl.dom/comment/
---
## Comment class

CharacterData에서 상속되고 주석의 내용을 나타냅니다.
...
| override [NodeName](../../aspose.finance.xbrl.dom/comment/nodename/) { get; } | 댓글의 노드 이름을 가져옵니다. |
