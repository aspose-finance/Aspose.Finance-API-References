...
description: Aspose.Finance.Xbrl.Dom.CharacterData 수업. CharacterData는 DOM의 문자 데이터에 액세스하기 위한 속성 및 메소드 세트로 Node를 확장합니다.
type: docs
weight: 6670
url: /ko/net/aspose.finance.xbrl.dom/characterdata/
---
## CharacterData class
