...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstanceUnitElement 수업. 클래스는 xbrl 인스턴스 단위 요소를 나타냅니다.
type: docs
weight: 7560
url: /ko/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceunitelement/
---
## XbrlInstanceUnitElement class

클래스는 xbrl 인스턴스 단위 요소를 나타냅니다.
