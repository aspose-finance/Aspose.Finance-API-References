...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstanceElement 수업. xbrl 인스턴스 요소의 기본 클래스입니다.
type: docs
weight: 7520
url: /ko/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceelement/
---
## XbrlInstanceElement class

xbrl 인스턴스 요소의 기본 클래스입니다.
