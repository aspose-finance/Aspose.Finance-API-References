...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstancePeroidElement 수업. 클래스는 xbrl 인스턴스 기간 요소를 나타냅니다.
type: docs
weight: 7550
url: /ko/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceperoidelement/
---
## XbrlInstancePeroidElement class

클래스는 xbrl 인스턴스 기간 요소를 나타냅니다.
