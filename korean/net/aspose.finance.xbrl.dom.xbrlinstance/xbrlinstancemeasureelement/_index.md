...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstanceMeasureElement 수업. 클래스는 xbrl 인스턴스 측정 요소를 나타냅니다.
type: docs
weight: 7540
url: /ko/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstancemeasureelement/
---
## XbrlInstanceMeasureElement class

클래스는 xbrl 인스턴스 측정 요소를 나타냅니다.
