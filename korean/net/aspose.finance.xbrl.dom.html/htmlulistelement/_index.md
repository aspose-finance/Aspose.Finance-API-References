...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLUListElement 수업. 클래스는 정렬되지 않은 목록을 나타냅니다. HTML 4.01의 UL 요소 정의를 참조하십시오.
type: docs
weight: 7300
url: /ko/net/aspose.finance.xbrl.dom.html/htmlulistelement/
---
## HTMLUListElement class

클래스는 정렬되지 않은 목록을 나타냅니다. HTML 4.01의 UL 요소 정의를 참조하십시오.
