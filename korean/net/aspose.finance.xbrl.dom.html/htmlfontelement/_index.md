...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFontElement 수업. 클래스는 글꼴에 대한 로컬 변경을 나타냅니다. HTML 4.01의 FONT 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 더 이상 사용되지 않습니다.
type: docs
weight: 6880
url: /ko/net/aspose.finance.xbrl.dom.html/htmlfontelement/
---
## HTMLFontElement class

클래스는 글꼴에 대한 로컬 변경을 나타냅니다. HTML 4.01의 FONT 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 더 이상 사용되지 않습니다.
