...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFrameElement 수업. 클래스는 html 프레임을 나타냅니다. HTML 4.01의 FRAME 요소 정의를 참조하십시오.
type: docs
weight: 6900
url: /ko/net/aspose.finance.xbrl.dom.html/htmlframeelement/
---
## HTMLFrameElement class

클래스는 html 프레임을 나타냅니다. HTML 4.01의 FRAME 요소 정의를 참조하십시오.
