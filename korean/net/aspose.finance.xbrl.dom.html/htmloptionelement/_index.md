...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLOptionElement 수업. 클래스는 선택 가능한 선택을 나타냅니다. HTML 4.01의 OPTION 요소 정의를 참조하십시오.
type: docs
weight: 7120
url: /ko/net/aspose.finance.xbrl.dom.html/htmloptionelement/
---
## HTMLOptionElement class

클래스는 선택 가능한 선택을 나타냅니다. HTML 4.01의 OPTION 요소 정의를 참조하십시오.
