...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLDListElement 수업. 클래스는 정의 목록을 나타냅니다. HTML 4.01의 DL 요소 정의를 참조하십시오.
type: docs
weight: 6820
url: /ko/net/aspose.finance.xbrl.dom.html/htmldlistelement/
---
## HTMLDListElement class

클래스는 정의 목록을 나타냅니다. HTML 4.01의 DL 요소 정의를 참조하십시오.
