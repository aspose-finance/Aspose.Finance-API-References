...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLParagraphElement 수업. 클래스는 단락을 나타냅니다. HTML 4.01의 P 요소 정의를 참조하십시오.
type: docs
weight: 7130
url: /ko/net/aspose.finance.xbrl.dom.html/htmlparagraphelement/
---
## HTMLParagraphElement class

클래스는 단락을 나타냅니다. HTML 4.01의 P 요소 정의를 참조하십시오.
