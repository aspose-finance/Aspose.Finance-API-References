...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLSelectElement 수업. 클래스는 선택 요소를 나타내며 옵션을 선택할 수 있습니다. 포함된 옵션은 컬렉션으로 선택 요소를 통해 직접 액세스할 수 있습니다. HTML 4.01. 의 SELECT 요소 정의를 참조하십시오.
type: docs
weight: 7180
url: /ko/net/aspose.finance.xbrl.dom.html/htmlselectelement/
---
## HTMLSelectElement class

클래스는 선택 요소를 나타내며 옵션을 선택할 수 있습니다. 포함된 옵션은 컬렉션으로 선택 요소를 통해 직접 액세스할 수 있습니다. HTML 4.01. 의 SELECT 요소 정의를 참조하십시오.
