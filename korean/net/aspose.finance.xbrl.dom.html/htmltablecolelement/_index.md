...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableColElement 수업. 클래스는 COL 요소를 나타냅니다. HTML 4.01의 COL 요소 정의를 참조하십시오.
type: docs
weight: 7220
url: /ko/net/aspose.finance.xbrl.dom.html/htmltablecolelement/
---
## HTMLTableColElement class

클래스는 COL 요소를 나타냅니다. HTML 4.01의 COL 요소 정의를 참조하십시오.
