...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLParamElement 수업. 클래스는 OBJECT 요소에 공급되는 매개변수를 나타냅니다. HTML 4.01의 PARAM 요소 정의를 참조하십시오.
type: docs
weight: 7140
url: /ko/net/aspose.finance.xbrl.dom.html/htmlparamelement/
---
## HTMLParamElement class

클래스는 OBJECT 요소에 공급되는 매개변수를 나타냅니다. HTML 4.01의 PARAM 요소 정의를 참조하십시오.
