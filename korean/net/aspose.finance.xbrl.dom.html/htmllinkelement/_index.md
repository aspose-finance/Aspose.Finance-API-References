...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLinkElement 수업. 클래스는 외부 리소스에 대한 링크를 지정하고 해당 리소스에 대한 이 문서의 관계또는 그 반대를 정의합니다. HTML 4.01 의 LINK 요소 정의를 참조하십시오.
type: docs
weight: 7030
url: /ko/net/aspose.finance.xbrl.dom.html/htmllinkelement/
---
## HTMLLinkElement class

클래스는 외부 리소스에 대한 링크를 지정하고 해당 리소스에 대한 이 문서의 관계(또는 그 반대)를 정의합니다. HTML 4.01 의 LINK 요소 정의를 참조하십시오.
