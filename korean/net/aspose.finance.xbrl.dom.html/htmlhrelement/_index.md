...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHRElement 수업. 이 클래스는 가로줄을 나타냅니다. HTML 4.01의 HR 요소 정의를 참조하십시오.
type: docs
weight: 6920
url: /ko/net/aspose.finance.xbrl.dom.html/htmlhrelement/
---
## HTMLHRElement class

이 클래스는 가로줄을 나타냅니다. HTML 4.01의 HR 요소 정의를 참조하십시오.
