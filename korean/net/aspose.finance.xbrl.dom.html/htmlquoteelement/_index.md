...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLQuoteElement 수업. 클래스는 Q 및 BLOCKQUOTE 요소를 나타냅니다. HTML 4.01의 Q 요소 정의를 참조하십시오.
type: docs
weight: 7160
url: /ko/net/aspose.finance.xbrl.dom.html/htmlquoteelement/
---
## HTMLQuoteElement class

클래스는 Q 및 BLOCKQUOTE 요소를 나타냅니다. HTML 4.01의 Q 요소 정의를 참조하십시오.
