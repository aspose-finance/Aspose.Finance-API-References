...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableRowElement 수업. 클래스는 테이블의 행을 나타냅니다. HTML 4.01의 TR 요소 정의를 참조하십시오.
type: docs
weight: 7250
url: /ko/net/aspose.finance.xbrl.dom.html/htmltablerowelement/
---
## HTMLTableRowElement class

클래스는 테이블의 행을 나타냅니다. HTML 4.01의 TR 요소 정의를 참조하십시오.
