...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLDivElement 수업. 클래스는 일반 블록 컨테이너를 나타냅니다. HTML 4.01의 DIV 요소 정의를 참조하십시오.
type: docs
weight: 6850
url: /ko/net/aspose.finance.xbrl.dom.html/htmldivelement/
---
## HTMLDivElement class

클래스는 일반 블록 컨테이너를 나타냅니다. HTML 4.01의 DIV 요소 정의를 참조하십시오.
