...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLNoScriptElement 수업. 클래스는 스크립트 문을 나타냅니다. HTML 4.01의 NOSCRIPT 요소 정의를 참조하십시오.
type: docs
weight: 7080
url: /ko/net/aspose.finance.xbrl.dom.html/htmlnoscriptelement/
---
## HTMLNoScriptElement class

클래스는 스크립트 문을 나타냅니다. HTML 4.01의 NOSCRIPT 요소 정의를 참조하십시오.
