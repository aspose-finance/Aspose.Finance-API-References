...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLIElement 수업. 클래스는 목록 항목을 나타냅니다. HTML 4.01의 LI 요소 정의를 참조하십시오.
type: docs
weight: 7000
url: /ko/net/aspose.finance.xbrl.dom.html/htmllielement/
---
## HTMLLIElement class

클래스는 목록 항목을 나타냅니다. HTML 4.01의 LI 요소 정의를 참조하십시오.
