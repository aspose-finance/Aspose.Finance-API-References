...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLOptGroupElement 수업. 클래스는 논리적 하위 구분에서 함께 그룹 옵션을 나타냅니다. HTML 4.01의 OPTGROUP 요소 정의를 참조하십시오.
type: docs
weight: 7110
url: /ko/net/aspose.finance.xbrl.dom.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

클래스는 논리적 하위 구분에서 함께 그룹 옵션을 나타냅니다. HTML 4.01의 OPTGROUP 요소 정의를 참조하십시오.
