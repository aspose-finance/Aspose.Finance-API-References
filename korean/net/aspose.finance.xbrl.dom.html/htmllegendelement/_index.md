...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLegendElement 수업. 클래스는 FIELDSET 그룹화에 대한 캡션을 나타냅니다. HTML 4.01의 LEGEND 요소 정의를 참조하십시오.
type: docs
weight: 7020
url: /ko/net/aspose.finance.xbrl.dom.html/htmllegendelement/
---
## HTMLLegendElement class

클래스는 FIELDSET 그룹화에 대한 캡션을 나타냅니다. HTML 4.01의 LEGEND 요소 정의를 참조하십시오.
