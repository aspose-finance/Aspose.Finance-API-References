...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLModElement 수업. 클래스는 문서의 일부에 대한 수정 알림을 나타냅니다. HTML 4.01의 INS 및 DEL 요소 정의를 참조하십시오.
type: docs
weight: 7070
url: /ko/net/aspose.finance.xbrl.dom.html/htmlmodelement/
---
## HTMLModElement class

클래스는 문서의 일부에 대한 수정 알림을 나타냅니다. HTML 4.01의 INS 및 DEL 요소 정의를 참조하십시오.
