...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTextAreaElement 수업. 클래스는 여러 줄 텍스트 필드를 나타냅니다. HTML 4.01의 TEXTAREA 요소 정의를 참조하십시오.
type: docs
weight: 7280
url: /ko/net/aspose.finance.xbrl.dom.html/htmltextareaelement/
---
## HTMLTextAreaElement class

클래스는 여러 줄 텍스트 필드를 나타냅니다. HTML 4.01의 TEXTAREA 요소 정의를 참조하십시오.
