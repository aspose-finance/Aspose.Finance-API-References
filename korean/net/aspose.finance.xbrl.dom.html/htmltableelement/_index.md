...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableElement 수업. 클래스는 테이블을 나타냅니다. HTML 4.01의 TABLE 요소 정의를 참조하십시오.
type: docs
weight: 7240
url: /ko/net/aspose.finance.xbrl.dom.html/htmltableelement/
---
## HTMLTableElement class

클래스는 테이블을 나타냅니다. HTML 4.01의 TABLE 요소 정의를 참조하십시오.
