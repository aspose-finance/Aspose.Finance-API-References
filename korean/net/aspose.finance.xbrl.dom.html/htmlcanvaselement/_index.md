...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLCanvasElement 수업. 이 클래스는 캔버스 요소의 레이아웃 및 표시를 조작하기 위한 속성 및 메서드를 제공합니다.
type: docs
weight: 6810
url: /ko/net/aspose.finance.xbrl.dom.html/htmlcanvaselement/
---
## HTMLCanvasElement class

이 클래스는 캔버스 요소의 레이아웃 및 표시를 조작하기 위한 속성 및 메서드를 제공합니다.
