...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLButtonElement 수업. 클래스는 푸시 버튼을 나타냅니다. HTML 4.01의 BUTTON 요소 정의를 참조하십시오.
type: docs
weight: 6800
url: /ko/net/aspose.finance.xbrl.dom.html/htmlbuttonelement/
---
## HTMLButtonElement class

클래스는 푸시 버튼을 나타냅니다. HTML 4.01의 BUTTON 요소 정의를 참조하십시오.
