...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLUnknownElement 수업. 클래스는 알 수 없는 html 요소를 나타냅니다.
type: docs
weight: 7310
url: /ko/net/aspose.finance.xbrl.dom.html/htmlunknownelement/
---
## HTMLUnknownElement class

클래스는 알 수 없는 html 요소를 나타냅니다.
