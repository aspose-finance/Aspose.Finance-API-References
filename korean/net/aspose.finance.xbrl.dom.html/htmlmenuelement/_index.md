...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLMenuElement 수업. 클래스는 메뉴 목록을 나타냅니다. HTML 4.01의 MENU 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 더 이상 사용되지 않습니다.
type: docs
weight: 7050
url: /ko/net/aspose.finance.xbrl.dom.html/htmlmenuelement/
---
## HTMLMenuElement class

클래스는 메뉴 목록을 나타냅니다. HTML 4.01의 MENU 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 더 이상 사용되지 않습니다.
