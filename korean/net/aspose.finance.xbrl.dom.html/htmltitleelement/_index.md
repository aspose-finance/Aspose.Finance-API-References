...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTitleElement 수업. 클래스는 제목 요소를 나타냅니다. HTML 4.01의 TITLE 요소 정의를 참조하십시오.
type: docs
weight: 7290
url: /ko/net/aspose.finance.xbrl.dom.html/htmltitleelement/
---
## HTMLTitleElement class

클래스는 제목 요소를 나타냅니다. HTML 4.01의 TITLE 요소 정의를 참조하십시오.
