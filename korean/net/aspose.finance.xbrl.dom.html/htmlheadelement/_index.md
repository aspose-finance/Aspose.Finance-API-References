...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHeadElement 수업. 클래스는 문서 헤드 정보를 나타냅니다. HTML 4.01의 HEAD 요소 정의를 참조하십시오.
type: docs
weight: 6930
url: /ko/net/aspose.finance.xbrl.dom.html/htmlheadelement/
---
## HTMLHeadElement class

클래스는 문서 헤드 정보를 나타냅니다. HTML 4.01의 HEAD 요소 정의를 참조하십시오.
