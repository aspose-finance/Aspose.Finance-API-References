...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLImageElement 수업. 클래스는 포함된 이미지를 나타냅니다. HTML 4.01의 IMG 요소 정의를 참조하십시오.
type: docs
weight: 6970
url: /ko/net/aspose.finance.xbrl.dom.html/htmlimageelement/
---
## HTMLImageElement class

클래스는 포함된 이미지를 나타냅니다. HTML 4.01의 IMG 요소 정의를 참조하십시오.
