...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLIsIndexElement 수업. 이 클래스는 한 줄 텍스트 입력에 사용됩니다. HTML 4.01의 ISINDEX 요소 정의를 참조하십시오. 이 요소는 HTML 4.01. 에서 더 이상 사용되지 않습니다.
type: docs
weight: 6990
url: /ko/net/aspose.finance.xbrl.dom.html/htmlisindexelement/
---
## HTMLIsIndexElement class

이 클래스는 한 줄 텍스트 입력에 사용됩니다. HTML 4.01의 ISINDEX 요소 정의를 참조하십시오. 이 요소는 HTML 4.01. 에서 더 이상 사용되지 않습니다.
