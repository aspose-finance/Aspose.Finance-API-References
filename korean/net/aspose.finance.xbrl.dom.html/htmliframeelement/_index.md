...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLIFrameElement 수업. 클래스는 인라인 하위 창을 나타냅니다. HTML 4.01의 IFRAME 요소 정의를 참조하십시오.
type: docs
weight: 6960
url: /ko/net/aspose.finance.xbrl.dom.html/htmliframeelement/
---
## HTMLIFrameElement class

클래스는 인라인 하위 창을 나타냅니다. HTML 4.01의 IFRAME 요소 정의를 참조하십시오.
