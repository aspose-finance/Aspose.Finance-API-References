...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLInputElement 수업. 클래스는 양식 컨트롤을 나타냅니다. 페이지를 보는 환경에 따라 파일 업로드 입력 유형에 대해 value 속성이 읽기 전용일 수 있습니다. 비밀번호 입력 유형의 경우 반환되는 실제 값은 무단 사용을 방지하기 위해 마스킹될 수 있습니다. HTML 4.01의 INPUT 요소 정의를 참조하십시오.
type: docs
weight: 6980
url: /ko/net/aspose.finance.xbrl.dom.html/htmlinputelement/
---
## HTMLInputElement class

클래스는 양식 컨트롤을 나타냅니다. 페이지를 보는 환경에 따라 파일 업로드 입력 유형에 대해 value 속성이 읽기 전용일 수 있습니다. "비밀번호" 입력 유형의 경우 반환되는 실제 값은 무단 사용을 방지하기 위해 마스킹될 수 있습니다. HTML 4.01의 INPUT 요소 정의를 참조하십시오.
...
| [ClassName](../../aspose.finance.xbrl.dom.html/htmlelement/classname/) { get; set; } | 요소의 클래스 특성을 가져오거나 설정합니다. 이 속성은 여러 언어에서 노출되는 "class" 키워드와의 충돌로 인해 이름이 변경되었습니다. HTML 4.01의 클래스 속성 정의를 참조하십시오. |
| [Dir](../../aspose.finance.xbrl.dom.html/htmlelement/dir/) { get; set; } | 방향성 중립 텍스트의 기본 방향과 테이블의 방향성을 가져오거나 설정합니다. HTML 4.01. 의 dir 속성 정의를 참조하십시오. |
...
| [Id](../../aspose.finance.xbrl.dom.html/htmlelement/id/) { get; set; } | 요소의 식별자를 가져오거나 설정합니다. HTML 4.01의 id 속성 정의를 참조하십시오. |
| [Lang](../../aspose.finance.xbrl.dom.html/htmlelement/lang/) { get; set; } | RFC 1766에 정의된 언어 코드를 가져오거나 설정합니다. HTML 4.01의 lang 속성 정의를 참조하십시오. |
...
| [Title](../../aspose.finance.xbrl.dom.html/htmlelement/title/) { get; set; } | 요소의 권고 제목을 가져오거나 설정합니다. HTML 4.01의 제목 속성 정의를 참조하십시오. |
...
* 네임스페이스 [Aspose.Finance.Xbrl.Dom.Html](../../aspose.finance.xbrl.dom.html/)
* 집회 [Aspose.Finance](../../)
