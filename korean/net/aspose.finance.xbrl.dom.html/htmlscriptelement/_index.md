...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLScriptElement 수업. 클래스는 스크립트 문을 나타냅니다. HTML 4.01의 SCRIPT 요소 정의를 참조하십시오.
type: docs
weight: 7170
url: /ko/net/aspose.finance.xbrl.dom.html/htmlscriptelement/
---
## HTMLScriptElement class

클래스는 스크립트 문을 나타냅니다. HTML 4.01의 SCRIPT 요소 정의를 참조하십시오.
