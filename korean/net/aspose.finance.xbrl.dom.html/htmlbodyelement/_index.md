...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBodyElement 수업. 클래스는 HTML 문서 본문을 나타냅니다. 이 요소는 소스 문서에 태그가 없는 경우에도 항상 DOM API에 있습니다. HTML 4.01의 BODY 요소 정의를 참조하십시오.
type: docs
weight: 6790
url: /ko/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

클래스는 HTML 문서 본문을 나타냅니다. 이 요소는 소스 문서에 태그가 없는 경우에도 항상 DOM API에 있습니다. HTML 4.01의 BODY 요소 정의를 참조하십시오.
