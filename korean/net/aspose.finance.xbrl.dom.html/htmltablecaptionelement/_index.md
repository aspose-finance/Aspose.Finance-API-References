...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableCaptionElement 수업. 클래스는 테이블 캡션을 나타냅니다. HTML 4.01의 CAPTION 요소 정의를 참조하십시오.
type: docs
weight: 7200
url: /ko/net/aspose.finance.xbrl.dom.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

클래스는 테이블 캡션을 나타냅니다. HTML 4.01의 CAPTION 요소 정의를 참조하십시오.
