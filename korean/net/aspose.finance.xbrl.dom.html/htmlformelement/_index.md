...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFormElement 수업. 이 클래스는 컬렉션 및 요소와 유사한 동작을 포함합니다. 포함된 양식 컨트롤과 양식 요소의 특성에 대한 직접 액세스를 제공합니다. HTML 4.01의 FORM 요소 정의를 참조하십시오.
type: docs
weight: 6890
url: /ko/net/aspose.finance.xbrl.dom.html/htmlformelement/
---
## HTMLFormElement class

이 클래스는 컬렉션 및 요소와 유사한 동작을 포함합니다. 포함된 양식 컨트롤과 양식 요소의 특성에 대한 직접 액세스를 제공합니다. HTML 4.01의 FORM 요소 정의를 참조하십시오.
