...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLMetaElement 수업. 클래스는 문서에 대한 일반 메타 정보를 포함합니다. HTML 4.01의 META 요소 정의를 참조하십시오.
type: docs
weight: 7060
url: /ko/net/aspose.finance.xbrl.dom.html/htmlmetaelement/
---
## HTMLMetaElement class

클래스는 문서에 대한 일반 메타 정보를 포함합니다. HTML 4.01의 META 요소 정의를 참조하십시오.
