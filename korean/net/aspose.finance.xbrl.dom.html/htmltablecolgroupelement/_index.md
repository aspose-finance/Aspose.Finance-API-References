...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableColGroupElement 수업. 클래스는 COLGROUP 요소를 나타냅니다. HTML 4.01의 COLGROUP 요소 정의를 참조하십시오.
type: docs
weight: 7230
url: /ko/net/aspose.finance.xbrl.dom.html/htmltablecolgroupelement/
---
## HTMLTableColGroupElement class

클래스는 COLGROUP 요소를 나타냅니다. HTML 4.01의 COLGROUP 요소 정의를 참조하십시오.
