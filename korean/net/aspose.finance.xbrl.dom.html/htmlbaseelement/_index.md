...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBaseElement 수업. 클래스는 문서 기반 URI를 나타냅니다. HTML 4.01의 BASE 요소 정의를 참조하십시오.
type: docs
weight: 6770
url: /ko/net/aspose.finance.xbrl.dom.html/htmlbaseelement/
---
## HTMLBaseElement class

클래스는 문서 기반 URI를 나타냅니다. HTML 4.01의 BASE 요소 정의를 참조하십시오.
