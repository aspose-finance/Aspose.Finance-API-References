...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFrameSetElement 수업. 이 클래스는 프레임 그리드를 나타냅니다. HTML 4.01의 FRAMESET 요소 정의를 참조하십시오.
type: docs
weight: 6910
url: /ko/net/aspose.finance.xbrl.dom.html/htmlframesetelement/
---
## HTMLFrameSetElement class

이 클래스는 프레임 그리드를 나타냅니다. HTML 4.01의 FRAMESET 요소 정의를 참조하십시오.
