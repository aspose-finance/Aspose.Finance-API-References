...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHtmlElement 수업. 클래스는 HTML 문서의 루트를 나타냅니다. HTML 4.01의 HTML 요소 정의를 참조하십시오.
type: docs
weight: 6950
url: /ko/net/aspose.finance.xbrl.dom.html/htmlhtmlelement/
---
## HTMLHtmlElement class

클래스는 HTML 문서의 루트를 나타냅니다. HTML 4.01의 HTML 요소 정의를 참조하십시오.
