...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHeadingElement 수업. 클래스는 H1  H6 요소를 나타냅니다. HTML 4.01의 H1 요소 정의를 참조하십시오.
type: docs
weight: 6940
url: /ko/net/aspose.finance.xbrl.dom.html/htmlheadingelement/
---
## HTMLHeadingElement class

클래스는 H1 ~ H6 요소를 나타냅니다. HTML 4.01의 H1 요소 정의를 참조하십시오.
