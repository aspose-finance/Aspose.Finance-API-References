...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLabelElement 수업. 클래스는 양식 필드 레이블 텍스트를 나타냅니다. HTML 4.01의 LABEL 요소 정의를 참조하십시오.
type: docs
weight: 7010
url: /ko/net/aspose.finance.xbrl.dom.html/htmllabelelement/
---
## HTMLLabelElement class

클래스는 양식 필드 레이블 텍스트를 나타냅니다. HTML 4.01의 LABEL 요소 정의를 참조하십시오.
