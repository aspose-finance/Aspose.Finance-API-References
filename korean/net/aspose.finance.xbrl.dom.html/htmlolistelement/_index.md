...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLOListElement 수업. 클래스는 정렬된 목록을 나타냅니다. HTML 4.01의 OL 요소 정의를 참조하십시오.
type: docs
weight: 7090
url: /ko/net/aspose.finance.xbrl.dom.html/htmlolistelement/
---
## HTMLOListElement class

클래스는 정렬된 목록을 나타냅니다. HTML 4.01의 OL 요소 정의를 참조하십시오.
