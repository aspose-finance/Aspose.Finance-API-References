...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLElement 수업. 모든 HTML 요소 클래스는 이 클래스에서 파생됩니다. HTML 핵심 속성만 노출하는 요소는 이 클래스로 표시되며 이러한 요소는 다음과 같습니다.  DFN CODE SAMP KBD VAR CITE ACRONYM ABBR 목록 DD DTNOFRAMES NOSCRIPTADDRESS CENTERT.
type: docs
weight: 6860
url: /ko/net/aspose.finance.xbrl.dom.html/htmlelement/
---
## HTMLElement class

모든 HTML 요소 클래스는 이 클래스에서 파생됩니다. HTML 핵심 속성만 노출하는 요소는 이 클래스로 표시되며 이러한 요소는 다음과 같습니다. , DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR 목록: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTERT.
