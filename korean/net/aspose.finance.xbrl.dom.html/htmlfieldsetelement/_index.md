...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFieldSetElement 수업. 양식 컨트롤을 논리 그룹으로 구성합니다. HTML 4.01의 FIELDSET 요소 정의를 참조하십시오.
type: docs
weight: 6870
url: /ko/net/aspose.finance.xbrl.dom.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

양식 컨트롤을 논리 그룹으로 구성합니다. HTML 4.01의 FIELDSET 요소 정의를 참조하십시오.
