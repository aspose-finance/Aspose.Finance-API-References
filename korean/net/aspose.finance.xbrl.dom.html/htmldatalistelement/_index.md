...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLDataListElement 수업. 클래스는 다른 컨트롤에 대해 미리 정의된 옵션을 나타내는 옵션 요소 집합을 나타냅니다.
type: docs
weight: 6830
url: /ko/net/aspose.finance.xbrl.dom.html/htmldatalistelement/
---
## HTMLDataListElement class

클래스는 다른 컨트롤에 대해 미리 정의된 옵션을 나타내는 옵션 요소 집합을 나타냅니다.
