...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLAnchorElement 수업. 클래스는 앵커 요소를 나타냅니다. HTML 4.01의 A 요소 정의를 참조하십시오.
type: docs
weight: 6730
url: /ko/net/aspose.finance.xbrl.dom.html/htmlanchorelement/
---
## HTMLAnchorElement class

클래스는 앵커 요소를 나타냅니다. HTML 4.01의 A 요소 정의를 참조하십시오.
