...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLAddressElement 수업. 클래스는 주소 요소를 나타냅니다. HTML 4.01의 ADDRESS 요소 정의를 참조하십시오.
type: docs
weight: 6720
url: /ko/net/aspose.finance.xbrl.dom.html/htmladdresselement/
---
## HTMLAddressElement class

클래스는 주소 요소를 나타냅니다. HTML 4.01의 ADDRESS 요소 정의를 참조하십시오.
