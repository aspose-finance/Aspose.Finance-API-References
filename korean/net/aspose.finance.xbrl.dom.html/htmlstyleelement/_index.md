...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLStyleElement 수업. 클래스는 스타일 정보를 나타냅니다. HTML 4.01. 의 STYLE 요소 정의를 참조하십시오.
type: docs
weight: 7190
url: /ko/net/aspose.finance.xbrl.dom.html/htmlstyleelement/
---
## HTMLStyleElement class

클래스는 스타일 정보를 나타냅니다. HTML 4.01. 의 STYLE 요소 정의를 참조하십시오.
