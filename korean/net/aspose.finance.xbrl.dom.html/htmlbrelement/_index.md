...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBRElement 수업. 클래스는 줄 바꿈을 나타냅니다. HTML 4.01의 BR 요소 정의를 참조하십시오.
type: docs
weight: 6760
url: /ko/net/aspose.finance.xbrl.dom.html/htmlbrelement/
---
## HTMLBRElement class

클래스는 줄 바꿈을 나타냅니다. HTML 4.01의 BR 요소 정의를 참조하십시오.
