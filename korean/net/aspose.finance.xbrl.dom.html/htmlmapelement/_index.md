...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLMapElement 수업. 클래스는 클라이언트 측 이미지 맵을 나타냅니다. HTML 4.01의 MAP 요소 정의를 참조하십시오.
type: docs
weight: 7040
url: /ko/net/aspose.finance.xbrl.dom.html/htmlmapelement/
---
## HTMLMapElement class

클래스는 클라이언트 측 이미지 맵을 나타냅니다. HTML 4.01의 MAP 요소 정의를 참조하십시오.
