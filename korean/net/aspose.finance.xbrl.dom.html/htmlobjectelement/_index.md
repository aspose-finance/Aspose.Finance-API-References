...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLObjectElement 수업. 클래스는 일반 포함 개체를 나타냅니다. 원칙적으로 개체 요소의 모든 속성은 읽기쓰기이지만 일부 환경에서는 기본 개체가 인스턴스화되면 일부 속성이 읽기 전용일 수 있습니다. HTML 4.01의 OBJECT 요소 정의를 참조하십시오.
type: docs
weight: 7100
url: /ko/net/aspose.finance.xbrl.dom.html/htmlobjectelement/
---
## HTMLObjectElement class

클래스는 일반 포함 개체를 나타냅니다. 원칙적으로 개체 요소의 모든 속성은 읽기-쓰기이지만 일부 환경에서는 기본 개체가 인스턴스화되면 일부 속성이 읽기 전용일 수 있습니다. HTML 4.01의 OBJECT 요소 정의를 참조하십시오.
