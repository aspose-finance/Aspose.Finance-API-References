...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLAreaElement 수업. 클래스는 클라이언트 측 이미지 맵 영역 정의를 나타냅니다. HTML 4.01의 AREA 요소 정의를 참조하십시오.
type: docs
weight: 6750
url: /ko/net/aspose.finance.xbrl.dom.html/htmlareaelement/
---
## HTMLAreaElement class

클래스는 클라이언트 측 이미지 맵 영역 정의를 나타냅니다. HTML 4.01의 AREA 요소 정의를 참조하십시오.
