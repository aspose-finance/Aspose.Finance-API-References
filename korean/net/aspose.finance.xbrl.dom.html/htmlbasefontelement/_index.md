...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBaseFontElement 수업. 클래스는 기본 글꼴을 나타냅니다. HTML 4.01의 BASEFONT 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 더 이상 사용되지 않습니다.
type: docs
weight: 6780
url: /ko/net/aspose.finance.xbrl.dom.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

클래스는 기본 글꼴을 나타냅니다. HTML 4.01의 BASEFONT 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 더 이상 사용되지 않습니다.
