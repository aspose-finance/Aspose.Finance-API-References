...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLPreElement 수업. 클래스는 미리 서식이 지정된 텍스트를 나타냅니다. HTML 4.01의 PRE 요소 정의를 참조하십시오.
type: docs
weight: 7150
url: /ko/net/aspose.finance.xbrl.dom.html/htmlpreelement/
---
## HTMLPreElement class

클래스는 미리 서식이 지정된 텍스트를 나타냅니다. HTML 4.01의 PRE 요소 정의를 참조하십시오.
