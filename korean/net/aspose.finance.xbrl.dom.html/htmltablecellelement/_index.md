...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableCellElement 수업. TH 및 TD 요소를 나타내는 데 사용되는 클래스입니다. HTML 4.01의 TD 요소 정의를 참조하십시오.
type: docs
weight: 7210
url: /ko/net/aspose.finance.xbrl.dom.html/htmltablecellelement/
---
## HTMLTableCellElement class

TH 및 TD 요소를 나타내는 데 사용되는 클래스입니다. HTML 4.01의 TD 요소 정의를 참조하십시오.
