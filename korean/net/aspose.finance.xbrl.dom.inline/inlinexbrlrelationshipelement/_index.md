...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlRelationshipElement 수업. 클래스는 인라인 xbrl 관계 요소를 나타냅니다.
type: docs
weight: 7420
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlrelationshipelement/
---
## InlineXbrlRelationshipElement class

클래스는 인라인 xbrl 관계 요소를 나타냅니다.
