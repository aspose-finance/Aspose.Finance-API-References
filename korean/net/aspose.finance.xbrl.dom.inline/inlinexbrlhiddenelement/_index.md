...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlHiddenElement 수업. 클래스는 인라인 xbrl 숨겨진 요소를 나타냅니다.
type: docs
weight: 7380
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlhiddenelement/
---
## InlineXbrlHiddenElement class

클래스는 인라인 xbrl 숨겨진 요소를 나타냅니다.
