...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlResourcesElement 수업. 클래스는 인라인 xbrl 리소스 요소를 나타냅니다.
type: docs
weight: 7430
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlresourceselement/
---
## InlineXbrlResourcesElement class

클래스는 인라인 xbrl 리소스 요소를 나타냅니다.
