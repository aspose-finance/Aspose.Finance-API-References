...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlExcludeElement 수업. 클래스는 인라인 xbrl 제외 요소를 나타냅니다.
type: docs
weight: 7340
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlexcludeelement/
---
## InlineXbrlExcludeElement class

클래스는 인라인 xbrl 제외 요소를 나타냅니다.
