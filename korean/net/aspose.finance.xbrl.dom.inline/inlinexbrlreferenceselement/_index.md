...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlReferencesElement 수업. 클래스는 인라인 xbrl 참조 요소를 나타냅니다.
type: docs
weight: 7410
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlreferenceselement/
---
## InlineXbrlReferencesElement class

클래스는 인라인 xbrl 참조 요소를 나타냅니다.
