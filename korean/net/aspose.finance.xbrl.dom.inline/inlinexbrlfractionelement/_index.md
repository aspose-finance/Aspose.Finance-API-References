...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlFractionElement 수업. 클래스는 인라인 xbrl 분수 요소를 나타냅니다.
type: docs
weight: 7360
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlfractionelement/
---
## InlineXbrlFractionElement class

클래스는 인라인 xbrl 분수 요소를 나타냅니다.
