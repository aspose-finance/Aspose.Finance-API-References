...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlHeaderElement 수업. 클래스는 인라인 xbrl 헤더 요소를 나타냅니다.
type: docs
weight: 7370
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlheaderelement/
---
## InlineXbrlHeaderElement class

클래스는 인라인 xbrl 헤더 요소를 나타냅니다.
