...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlTupleElement 수업. 클래스는 인라인 xbrl 튜플 요소를 나타냅니다.
type: docs
weight: 7440
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrltupleelement/
---
## InlineXbrlTupleElement class

클래스는 인라인 xbrl 튜플 요소를 나타냅니다.
