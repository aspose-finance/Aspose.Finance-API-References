...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlFootnoteElement 수업. 클래스는 인라인 xbrl 각주 요소를 나타냅니다.
type: docs
weight: 7350
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlfootnoteelement/
---
## InlineXbrlFootnoteElement class

클래스는 인라인 xbrl 각주 요소를 나타냅니다.
