...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlContinuationElement 수업. 클래스는 인라인 xbrl 연속 요소를 나타냅니다.
type: docs
weight: 7320
url: /ko/net/aspose.finance.xbrl.dom.inline/inlinexbrlcontinuationelement/
---
## InlineXbrlContinuationElement class

클래스는 인라인 xbrl 연속 요소를 나타냅니다.
