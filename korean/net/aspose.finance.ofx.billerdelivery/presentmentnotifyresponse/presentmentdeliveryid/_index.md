...
description: PresentmentNotifyResponse 재산. 가져오거나 설정합니다.PresentmentDeliveryId .
type: docs
weight: 20
url: /ko/net/aspose.finance.ofx.billerdelivery/presentmentnotifyresponse/presentmentdeliveryid/
---
## PresentmentNotifyResponse.PresentmentDeliveryId property

가져오거나 설정합니다.`PresentmentDeliveryId` .
