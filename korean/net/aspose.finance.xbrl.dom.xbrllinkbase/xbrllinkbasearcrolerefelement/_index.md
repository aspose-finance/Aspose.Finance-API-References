...
description: Aspose.Finance.Xbrl.Dom.XbrlLinkbase.XbrlLinkbaseArcroleRefElement 수업. 클래스는 xbrl linkbase arcroleRef 요소를 나타냅니다.
type: docs
weight: 7570
url: /ko/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbasearcrolerefelement/
---
## XbrlLinkbaseArcroleRefElement class

클래스는 xbrl linkbase arcroleRef 요소를 나타냅니다.
