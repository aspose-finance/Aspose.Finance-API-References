...
description: Aspose.Finance.Xbrl.Dom.XbrlLinkbase.XbrlLinkbaseRoleRefElement 수업. 클래스는 xbrl linkbase roleRef 요소를 나타냅니다.
type: docs
weight: 7600
url: /ko/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaserolerefelement/
---
## XbrlLinkbaseRoleRefElement class

클래스는 xbrl linkbase roleRef 요소를 나타냅니다.
