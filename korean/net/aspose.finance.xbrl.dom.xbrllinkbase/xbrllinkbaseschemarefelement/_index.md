...
description: Aspose.Finance.Xbrl.Dom.XbrlLinkbase.XbrlLinkbaseSchemaRefElement 수업. 클래스는 xbrl linkbase schemaRef 요소를 나타냅니다.
type: docs
weight: 7610
url: /ko/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaseschemarefelement/
---
## XbrlLinkbaseSchemaRefElement class

클래스는 xbrl linkbase schemaRef 요소를 나타냅니다.
