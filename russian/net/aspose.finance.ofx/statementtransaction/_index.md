...
| Имя | Описание |
| --- | --- |
| [StatementTransaction](statementtransaction)() | Инициализирует новый экземпляр класса[`StatementTransaction`](../statementtransaction). |

## Характеристики

| Имя | Описание |
| --- | --- |
| [AccountTo](../../aspose.finance.ofx/statementtransaction/accountto) { get; set; } | Получает или задает счет для[`BankAccount`](../bankaccount)или[`CreditCardAccount`](../creditcardaccount). |
| [AvailableDate](../../aspose.finance.ofx/statementtransaction/availabledate) { get; set; } | Получает или задает дату доступности средств (дату валютирования). |
...
| [Memo](../../aspose.finance.ofx/statementtransaction/memo) { get; set; } | Получает или задает дополнительную информацию. |
...
| [OriginCurrency](../../aspose.finance.ofx/statementtransaction/origincurrency) { get; set; } | Получает или задает Origin[`Currency`](./currency). |
| [Payee](../../aspose.finance.ofx/statementtransaction/payee) { get; set; } | Получает или задает[`Payee`](./payee). |
| [PayeeId](../../aspose.finance.ofx/statementtransaction/payeeid) { get; set; } | Получает или задает идентификатор получателя платежа, если он доступен. |
| [PostedDate](../../aspose.finance.ofx/statementtransaction/posteddate) { get; set; } | Получает или задает дату публикации транзакции в аккаунте. |
...
| [ServerTransactionId](../../aspose.finance.ofx/statementtransaction/servertransactionid) { get; set; } | Получает или задает назначенный сервером идентификатор транзакции. |
...
| [TransactionAmount](../../aspose.finance.ofx/statementtransaction/transactionamount) { get; set; } | Получает или задает сумму транзакции. |
