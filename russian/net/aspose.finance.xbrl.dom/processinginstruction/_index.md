...
description: Класс представляет инструкцию по обработке используемую в XML как способ сохранения в тексте документа информации относящейся к процессору.
type: docs
weight: 7450
url: /ru/net/aspose.finance.xbrl.dom/processinginstruction/
---
## ProcessingInstruction class

Класс представляет "инструкцию по обработке", используемую в XML как способ сохранения в тексте документа информации, относящейся к процессору.
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename) { get; } | Получает имя этой инструкции по обработке. |
