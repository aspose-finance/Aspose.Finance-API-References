...
description: Класс представляет собой инструкцию по обработке используемую в XML как способ сохранения в тексте документа информации относящейся к процессору.
type: docs
weight: 7450
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename) { get; } | Получает имя этой инструкции обработки. |
