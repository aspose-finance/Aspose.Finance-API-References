...
| const [DOCUMENT_TYPE_NODE](../../aspose.finance.xbrl.dom/node/document_type_node) | Тип узла тип документа. |
...
| const [TEXT_NODE](../../aspose.finance.xbrl.dom/node/text_node) | Текстовый тип узла. |
