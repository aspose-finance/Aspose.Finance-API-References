...
description: Интерфейс Element представляет элемент встроенного документа xbrl.
type: docs
weight: 6670
url: /ru/net/aspose.finance.xbrl.dom/element/
---
## Element class

Интерфейс Element представляет элемент встроенного документа xbrl.
