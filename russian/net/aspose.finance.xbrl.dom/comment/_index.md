...
description: Наследуется от CharacterData и представляет содержимое комментария.
type: docs
weight: 6650
url: /ru/net/aspose.finance.xbrl.dom/comment/
---
## Comment class

Наследуется от CharacterData и представляет содержимое комментария.
...
| override [NodeName](../../aspose.finance.xbrl.dom/comment/nodename) { get; } | Получает имя узла комментария. |
