...
description: Этот класс являетсяXlink./xlink с типом дуги. Он соединяет концепции со справочными ресурсами.
type: docs
weight: 7910
...
Этот класс является[`Xlink`](../xlink) с типом дуги. Он соединяет концепции со справочными ресурсами.
