...
description: Этот класс используется для обозначения ссылки на базу ссылок.
type: docs
weight: 7800
url: /ru/net/aspose.finance.xbrl/labellinkbaseref/
---
## LabelLinkbaseRef class

Этот класс используется для обозначения ссылки на базу ссылок.
