...
description: Этот класс представляет собой классXlink./xlinkс типом Arc. Он определяет как Концепты соотносятся друг с другом в целях расчета.
type: docs
weight: 6500
...
Этот класс представляет собой класс[`Xlink`](../xlink)с типом Arc. Он определяет, как Концепты соотносятся друг с другом в целях расчета.
...
| [GetToLocs](../../aspose.finance.xbrl/calculationarc/gettolocs)() | Получает коллекцию для[`Loc`](../loc)в[`CalculationArc`](../calculationarc). |
