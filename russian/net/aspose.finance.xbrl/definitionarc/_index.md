...
description: Этот класс являетсяXlink./xlink с типом дуги. Он определяет различные виды отношений между понятиями.
type: docs
weight: 6590
...
Этот класс является[`Xlink`](../xlink) с типом дуги. Он определяет различные виды отношений между понятиями.
