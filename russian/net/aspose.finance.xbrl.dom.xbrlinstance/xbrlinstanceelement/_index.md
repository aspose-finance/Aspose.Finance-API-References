...
description: Базовый класс элемента экземпляра xbrl.
type: docs
weight: 7490
url: /ru/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceelement/
---
## XbrlInstanceElement class

Базовый класс элемента экземпляра xbrl.
