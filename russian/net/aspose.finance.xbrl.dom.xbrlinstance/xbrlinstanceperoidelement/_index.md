...
description: Класс представляет элемент периода экземпляра xbrl.
type: docs
weight: 7520
url: /ru/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceperoidelement/
---
## XbrlInstancePeroidElement class

Класс представляет элемент периода экземпляра xbrl.
