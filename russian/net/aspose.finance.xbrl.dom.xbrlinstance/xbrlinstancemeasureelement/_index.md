...
description: Класс представляет элемент измерения экземпляра xbrl.
type: docs
weight: 7510
url: /ru/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstancemeasureelement/
---
## XbrlInstanceMeasureElement class

Класс представляет элемент измерения экземпляра xbrl.
