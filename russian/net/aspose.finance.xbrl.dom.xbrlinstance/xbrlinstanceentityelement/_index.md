...
description: Класс представляет элемент сущности экземпляра xbrl.
type: docs
weight: 7500
url: /ru/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceentityelement/
---
## XbrlInstanceEntityElement class

Класс представляет элемент сущности экземпляра xbrl.
