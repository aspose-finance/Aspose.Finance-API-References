...
description: Класс представляет элемент экземпляра xbrl.
type: docs
weight: 7530
url: /ru/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceunitelement/
---
## XbrlInstanceUnitElement class

Класс представляет элемент экземпляра xbrl.
