...
description: Класс представляет элемент linkbaseRef базы ссылок xbrl.
type: docs
weight: 7560
url: /ru/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaselinkbaserefelement/
---
## XbrlLinkbaseLinkbaseRefElement class

Класс представляет элемент linkbaseRef базы ссылок xbrl.
