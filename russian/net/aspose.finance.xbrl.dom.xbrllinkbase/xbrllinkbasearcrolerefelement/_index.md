...
description: Класс представляет элемент arcroleRef базы ссылок xbrl.
type: docs
weight: 7540
url: /ru/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbasearcrolerefelement/
---
## XbrlLinkbaseArcroleRefElement class

Класс представляет элемент arcroleRef базы ссылок xbrl.
