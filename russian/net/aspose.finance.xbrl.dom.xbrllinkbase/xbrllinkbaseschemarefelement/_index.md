...
description: Класс представляет элемент schemaRef базы ссылок xbrl.
type: docs
weight: 7580
url: /ru/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaseschemarefelement/
---
## XbrlLinkbaseSchemaRefElement class

Класс представляет элемент schemaRef базы ссылок xbrl.
...
* пространство имен [Aspose.Finance.Xbrl.Dom.XbrlLinkbase](../../aspose.finance.xbrl.dom.xbrllinkbase)
