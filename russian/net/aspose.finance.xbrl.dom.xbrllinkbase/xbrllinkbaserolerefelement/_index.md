...
description: Класс представляет элемент roleRef базы ссылок xbrl.
type: docs
weight: 7570
url: /ru/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaserolerefelement/
---
## XbrlLinkbaseRoleRefElement class

Класс представляет элемент roleRef базы ссылок xbrl.
