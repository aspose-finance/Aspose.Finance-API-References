...
description: Класс представляет встроенный элемент дроби xbrl.
type: docs
weight: 7330
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlfractionelement/
---
## InlineXbrlFractionElement class

Класс представляет встроенный элемент дроби xbrl.
