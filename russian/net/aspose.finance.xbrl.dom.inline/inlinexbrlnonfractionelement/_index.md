...
description: Класс представляет встроенный элемент xbrl nonFraction.
type: docs
weight: 7360
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlnonfractionelement/
---
## InlineXbrlNonFractionElement class

Класс представляет встроенный элемент xbrl nonFraction.
