...
description: Класс представляет встроенный скрытый элемент xbrl.
type: docs
weight: 7350
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlhiddenelement/
---
## InlineXbrlHiddenElement class

Класс представляет встроенный скрытый элемент xbrl.
