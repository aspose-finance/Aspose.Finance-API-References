...
description: Класс представляет встроенный элемент заголовка xbrl.
type: docs
weight: 7340
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlheaderelement/
---
## InlineXbrlHeaderElement class

Класс представляет встроенный элемент заголовка xbrl.
