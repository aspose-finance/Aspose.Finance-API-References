...
description: Класс представляет элемент встроенных ссылок xbrl.
type: docs
weight: 7380
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlreferenceselement/
---
## InlineXbrlReferencesElement class

Класс представляет элемент встроенных ссылок xbrl.
