...
description: Класс представляет встроенный элемент сноски xbrl.
type: docs
weight: 7320
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlfootnoteelement/
---
## InlineXbrlFootnoteElement class

Класс представляет встроенный элемент сноски xbrl.
