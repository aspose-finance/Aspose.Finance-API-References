...
description: Класс представляет встроенный нечисловой элемент xbrl.
type: docs
weight: 7370
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlnonnumericelement/
---
## InlineXbrlNonNumericElement class

Класс представляет встроенный нечисловой элемент xbrl.
