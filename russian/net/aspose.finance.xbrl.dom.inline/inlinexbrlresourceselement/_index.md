...
description: Класс представляет встроенный элемент ресурсов xbrl.
type: docs
weight: 7400
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlresourceselement/
---
## InlineXbrlResourcesElement class

Класс представляет встроенный элемент ресурсов xbrl.
