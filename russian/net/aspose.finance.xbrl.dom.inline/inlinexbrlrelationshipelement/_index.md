...
description: Класс представляет встроенный элемент отношения xbrl.
type: docs
weight: 7390
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlrelationshipelement/
---
## InlineXbrlRelationshipElement class

Класс представляет встроенный элемент отношения xbrl.
