...
description: Класс представляет встроенный элемент исключения xbrl.
type: docs
weight: 7310
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlexcludeelement/
---
## InlineXbrlExcludeElement class

Класс представляет встроенный элемент исключения xbrl.
