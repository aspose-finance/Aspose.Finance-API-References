...
description: Класс представляет встроенный элемент продолжения xbrl.
type: docs
weight: 7290
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrlcontinuationelement/
---
## InlineXbrlContinuationElement class

Класс представляет встроенный элемент продолжения xbrl.
...
* пространство имен [Aspose.Finance.Xbrl.Dom.Inline](../../aspose.finance.xbrl.dom.inline)
