...
description: Класс представляет встроенный элемент кортежа xbrl.
type: docs
weight: 7410
url: /ru/net/aspose.finance.xbrl.dom.inline/inlinexbrltupleelement/
---
## InlineXbrlTupleElement class

Класс представляет встроенный элемент кортежа xbrl.
