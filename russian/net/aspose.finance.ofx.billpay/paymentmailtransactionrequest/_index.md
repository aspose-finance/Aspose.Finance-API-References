...
description: Класс запроса платежной электронной почты.
type: docs
weight: 1160
url: /ru/net/aspose.finance.ofx.billpay/paymentmailtransactionrequest/
---
## PaymentMailTransactionRequest class

Класс запроса платежной электронной почты.
