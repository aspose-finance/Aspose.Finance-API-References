...
description: Класс представляет уведомление об изменении части документа. См. определения элементов INS и DEL в HTML 4.01.
type: docs
weight: 7040
url: /ru/net/aspose.finance.xbrl.dom.html/htmlmodelement/
---
## HTMLModElement class

Класс представляет уведомление об изменении части документа. См. определения элементов INS и DEL в HTML 4.01.
