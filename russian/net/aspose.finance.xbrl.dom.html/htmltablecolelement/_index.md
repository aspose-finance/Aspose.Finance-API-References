...
description: Класс представляет элемент COL. См. определение элемента COL в HTML 4.01.
type: docs
weight: 7190
url: /ru/net/aspose.finance.xbrl.dom.html/htmltablecolelement/
---
## HTMLTableColElement class

Класс представляет элемент COL. См. определение элемента COL в HTML 4.01.
