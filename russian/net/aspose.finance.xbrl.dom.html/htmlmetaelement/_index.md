...
description: Класс содержит общую метаинформацию о документе. См. определение элемента META в HTML 4.01.
type: docs
weight: 7030
url: /ru/net/aspose.finance.xbrl.dom.html/htmlmetaelement/
---
## HTMLMetaElement class

Класс содержит общую метаинформацию о документе. См. определение элемента META в HTML 4.01.
