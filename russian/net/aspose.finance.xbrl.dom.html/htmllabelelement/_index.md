...
description: Класс представляет текст метки поля формы. См. определение элемента LABEL в HTML 4.01.
type: docs
weight: 6980
url: /ru/net/aspose.finance.xbrl.dom.html/htmllabelelement/
---
## HTMLLabelElement class

Класс представляет текст метки поля формы. См. определение элемента LABEL в HTML 4.01.
