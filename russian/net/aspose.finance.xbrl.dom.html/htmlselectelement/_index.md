...
description: Класс представляет элемент выбора позволяющий выбрать параметр. Доступ к содержащимся параметрам можно получить напрямую через элемент select в виде коллекции. См. определение элемента SELECT в HTML 4.01. .
type: docs
weight: 7150
url: /ru/net/aspose.finance.xbrl.dom.html/htmlselectelement/
---
## HTMLSelectElement class

Класс представляет элемент выбора, позволяющий выбрать параметр. Доступ к содержащимся параметрам можно получить напрямую через элемент select в виде коллекции. См. определение элемента SELECT в HTML 4.01. .
