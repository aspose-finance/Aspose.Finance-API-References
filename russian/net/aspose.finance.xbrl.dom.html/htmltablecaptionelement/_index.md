...
description: Класс представляет заголовок таблицы. См. определение элемента CAPTION в HTML 4.01.
type: docs
weight: 7170
url: /ru/net/aspose.finance.xbrl.dom.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Класс представляет заголовок таблицы. См. определение элемента CAPTION в HTML 4.01.
