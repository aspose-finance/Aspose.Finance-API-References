...
description: Класс представляет базовый шрифт. См. определение элемента BASEFONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 6750
url: /ru/net/aspose.finance.xbrl.dom.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Класс представляет базовый шрифт. См. определение элемента BASEFONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
