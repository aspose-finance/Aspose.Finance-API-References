...
description: Класс представляет список меню. См. определение элемента MENU в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 7020
url: /ru/net/aspose.finance.xbrl.dom.html/htmlmenuelement/
---
## HTMLMenuElement class

Класс представляет список меню. См. определение элемента MENU в HTML 4.01. Этот элемент устарел в HTML 4.01.
