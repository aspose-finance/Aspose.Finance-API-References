...
description: Класс представляет встроенное изображение. См. определение элемента IMG в HTML 4.01.
type: docs
weight: 6940
url: /ru/net/aspose.finance.xbrl.dom.html/htmlimageelement/
---
## HTMLImageElement class

Класс представляет встроенное изображение. См. определение элемента IMG в HTML 4.01.
