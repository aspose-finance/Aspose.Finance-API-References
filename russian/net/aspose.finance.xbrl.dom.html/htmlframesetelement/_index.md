...
description: Этот класс представляет сетку кадров. См. определение элемента FRAMESET в HTML 4.01.
type: docs
weight: 6880
url: /ru/net/aspose.finance.xbrl.dom.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Этот класс представляет сетку кадров. См. определение элемента FRAMESET в HTML 4.01.
