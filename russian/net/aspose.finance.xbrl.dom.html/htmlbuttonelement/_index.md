...
description: Класс представляет кнопку. См. определение элемента BUTTON в HTML 4.01.
type: docs
weight: 6770
url: /ru/net/aspose.finance.xbrl.dom.html/htmlbuttonelement/
---
## HTMLButtonElement class

Класс представляет кнопку. См. определение элемента BUTTON в HTML 4.01.
