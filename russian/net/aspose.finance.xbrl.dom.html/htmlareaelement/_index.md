...
description: Класс представляет определение области карты изображения на стороне клиента. См. определение элемента AREA в HTML 4.01.
type: docs
weight: 6720
url: /ru/net/aspose.finance.xbrl.dom.html/htmlareaelement/
---
## HTMLAreaElement class

Класс представляет определение области карты изображения на стороне клиента. См. определение элемента AREA в HTML 4.01.
