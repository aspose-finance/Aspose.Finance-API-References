...
description: Класс представляет строку в таблице. См. определение элемента TR в HTML 4.01.
type: docs
weight: 7220
url: /ru/net/aspose.finance.xbrl.dom.html/htmltablerowelement/
---
## HTMLTableRowElement class

Класс представляет строку в таблице. См. определение элемента TR в HTML 4.01.
