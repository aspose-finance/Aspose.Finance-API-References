...
description: Класс представляет элемент адреса. См. определение элемента ADDRESS в HTML 4.01.
type: docs
weight: 6690
url: /ru/net/aspose.finance.xbrl.dom.html/htmladdresselement/
---
## HTMLAddressElement class

Класс представляет элемент адреса. См. определение элемента ADDRESS в HTML 4.01.
