...
description: Класс представляет элементы Q и BLOCKQUOTE. См. определение элемента Q в HTML 4.01.
type: docs
weight: 7130
url: /ru/net/aspose.finance.xbrl.dom.html/htmlquoteelement/
---
## HTMLQuoteElement class

Класс представляет элементы Q и BLOCKQUOTE. См. определение элемента Q в HTML 4.01.
