...
description: Класс представляет встроенные подокна. См. определение элемента IFRAME в HTML 4.01.
type: docs
weight: 6930
url: /ru/net/aspose.finance.xbrl.dom.html/htmliframeelement/
---
## HTMLIFrameElement class

Класс представляет встроенные подокна. См. определение элемента IFRAME в HTML 4.01.
