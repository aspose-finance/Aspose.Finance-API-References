...
description: Класс представляет элемент заголовка. См. определение элемента TITLE в HTML 4.01.
type: docs
weight: 7260
url: /ru/net/aspose.finance.xbrl.dom.html/htmltitleelement/
---
## HTMLTitleElement class

Класс представляет элемент заголовка. См. определение элемента TITLE в HTML 4.01.
