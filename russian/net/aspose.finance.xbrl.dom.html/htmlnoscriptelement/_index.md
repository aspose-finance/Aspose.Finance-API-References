...
description: Класс представляет операторы сценария. См. определение элемента NOSCRIPT в HTML 4.01.
type: docs
weight: 7050
url: /ru/net/aspose.finance.xbrl.dom.html/htmlnoscriptelement/
---
## HTMLNoScriptElement class

Класс представляет операторы сценария. См. определение элемента NOSCRIPT в HTML 4.01.
