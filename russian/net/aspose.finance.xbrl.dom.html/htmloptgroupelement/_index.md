...
description: Класс представляет групповые опции вместе в логических подразделениях. См. определение элемента OPTGROUP в HTML 4.01.
type: docs
weight: 7080
...
Класс представляет групповые опции вместе в логических подразделениях. См. определение элемента OPTGROUP в HTML 4.01.
