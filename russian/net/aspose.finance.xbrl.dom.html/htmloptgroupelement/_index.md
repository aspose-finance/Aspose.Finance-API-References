...
description: Класс представляет параметры группы вместе в логических подразделениях. См. определение элемента OPTGROUP в HTML 4.01.
type: docs
weight: 7080
url: /ru/net/aspose.finance.xbrl.dom.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Класс представляет параметры группы вместе в логических подразделениях. См. определение элемента OPTGROUP в HTML 4.01.
