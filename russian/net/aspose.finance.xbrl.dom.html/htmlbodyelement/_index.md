...
description: Класс представляет тело HTMLдокумента. Этот элемент всегда присутствует в DOM API даже если теги отсутствуют в исходном документе. См. определение элемента BODY в HTML 4.01.
type: docs
weight: 6760
url: /ru/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

Класс представляет тело HTML-документа. Этот элемент всегда присутствует в DOM API, даже если теги отсутствуют в исходном документе. См. определение элемента BODY в HTML 4.01.
