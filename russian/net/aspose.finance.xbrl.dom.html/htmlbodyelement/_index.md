...
description: Класс представляет тело документа HTML. Этот элемент всегда присутствует в DOM API даже если теги отсутствуют в исходном документе. См. определение элемента BODY в HTML 4.01.
type: docs
weight: 6760
...
Класс представляет тело документа HTML. Этот элемент всегда присутствует в DOM API, даже если теги отсутствуют в исходном документе. См. определение элемента BODY в HTML 4.01.
