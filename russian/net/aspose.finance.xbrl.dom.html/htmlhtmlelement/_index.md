...
description: Класс представляет корень документа HTML. См. определение HTMLэлемента в HTML 4.01.
type: docs
weight: 6920
url: /ru/net/aspose.finance.xbrl.dom.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Класс представляет корень документа HTML. См. определение HTML-элемента в HTML 4.01.
