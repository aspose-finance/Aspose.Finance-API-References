...
description: Класс представляет список каталогов. См. определение элемента DIR в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 6810
url: /ru/net/aspose.finance.xbrl.dom.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Класс представляет список каталогов. См. определение элемента DIR в HTML 4.01. Этот элемент устарел в HTML 4.01.
