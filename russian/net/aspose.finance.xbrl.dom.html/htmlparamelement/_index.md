...
description: Класс представляет параметры подаваемые в элемент OBJECT. См. определение элемента PARAM в HTML 4.01.
type: docs
weight: 7110
url: /ru/net/aspose.finance.xbrl.dom.html/htmlparamelement/
---
## HTMLParamElement class

Класс представляет параметры, подаваемые в элемент OBJECT. См. определение элемента PARAM в HTML 4.01.
