...
description: Класс представляет собой выбор. См. определение элемента OPTION в HTML 4.01.
type: docs
weight: 7090
url: /ru/net/aspose.finance.xbrl.dom.html/htmloptionelement/
---
## HTMLOptionElement class

Класс представляет собой выбор. См. определение элемента OPTION в HTML 4.01.
