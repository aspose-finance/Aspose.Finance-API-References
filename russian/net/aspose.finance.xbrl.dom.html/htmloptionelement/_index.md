...
description: Класс представляет выбираемый вариант. См. определение элемента OPTION в HTML 4.01.
type: docs
weight: 7090
...
Класс представляет выбираемый вариант. См. определение элемента OPTION в HTML 4.01.
