...
description: Класс представляет общий встроенный объект. В принципе все свойства элемента объекта доступны для чтения и записи но в некоторых средах некоторые свойства могут быть доступны только для чтения после создания экземпляра базового объекта. См. определение элемента OBJECT в HTML 4.01.
type: docs
weight: 7070
url: /ru/net/aspose.finance.xbrl.dom.html/htmlobjectelement/
---
## HTMLObjectElement class

Класс представляет общий встроенный объект. В принципе, все свойства элемента объекта доступны для чтения и записи, но в некоторых средах некоторые свойства могут быть доступны только для чтения после создания экземпляра базового объекта. См. определение элемента OBJECT в HTML 4.01.
...
| [Title](../../aspose.finance.xbrl.dom.html/htmlelement/title) { get; set; } | Получает или задает рекомендательный заголовок элемента. См. определение атрибута title в HTML 4.01. |
...
| [HasAttribute](../../aspose.finance.xbrl.dom/element/hasattribute)(string) | Возвращает значение true, если атрибут с заданным именем указан в этом элементе или имеет значение по умолчанию, в противном случае — значение false. |
