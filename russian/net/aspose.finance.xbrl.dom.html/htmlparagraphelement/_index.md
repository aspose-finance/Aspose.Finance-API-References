...
description: Класс представляет абзацы. См. определение элемента P в HTML 4.01.
type: docs
weight: 7100
url: /ru/net/aspose.finance.xbrl.dom.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Класс представляет абзацы. См. определение элемента P в HTML 4.01.
