...
description: Класс предоставляет свойства и методы для управления компоновкой и представлением элементов холста.
type: docs
weight: 6780
url: /ru/net/aspose.finance.xbrl.dom.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Класс предоставляет свойства и методы для управления компоновкой и представлением элементов холста.
