...
description: Класс представляет предварительно отформатированный текст. См. определение элемента PRE в HTML 4.01.
type: docs
weight: 7120
url: /ru/net/aspose.finance.xbrl.dom.html/htmlpreelement/
---
## HTMLPreElement class

Класс представляет предварительно отформатированный текст. См. определение элемента PRE в HTML 4.01.
