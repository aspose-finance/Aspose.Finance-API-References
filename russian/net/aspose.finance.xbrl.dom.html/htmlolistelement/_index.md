...
description: Класс представляет собой упорядоченный список. См. определение элемента OL в HTML 4.01.
type: docs
weight: 7060
url: /ru/net/aspose.finance.xbrl.dom.html/htmlolistelement/
---
## HTMLOListElement class

Класс представляет собой упорядоченный список. См. определение элемента OL в HTML 4.01.
