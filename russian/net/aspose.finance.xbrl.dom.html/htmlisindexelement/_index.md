...
description: Этот класс используется для однострочного ввода текста. См. определение элемента ISINDEX в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 6960
url: /ru/net/aspose.finance.xbrl.dom.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Этот класс используется для однострочного ввода текста. См. определение элемента ISINDEX в HTML 4.01. Этот элемент устарел в HTML 4.01.
