...
description: Класс представляет собой таблицу. См. определение элемента TABLE в HTML 4.01.
type: docs
weight: 7210
url: /ru/net/aspose.finance.xbrl.dom.html/htmltableelement/
---
## HTMLTableElement class

Класс представляет собой таблицу. См. определение элемента TABLE в HTML 4.01.
