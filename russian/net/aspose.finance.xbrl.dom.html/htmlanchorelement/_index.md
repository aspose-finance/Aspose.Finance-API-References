...
description: Класс представляет элемент привязки. См. определение элемента A в HTML 4.01.
type: docs
weight: 6700
url: /ru/net/aspose.finance.xbrl.dom.html/htmlanchorelement/
---
## HTMLAnchorElement class

Класс представляет элемент привязки. См. определение элемента A в HTML 4.01.
