...
description: Класс представляет элементы от H1 до H6. См. определение элемента H1 в HTML 4.01.
type: docs
weight: 6910
url: /ru/net/aspose.finance.xbrl.dom.html/htmlheadingelement/
---
## HTMLHeadingElement class

Класс представляет элементы от H1 до H6. См. определение элемента H1 в HTML 4.01.
