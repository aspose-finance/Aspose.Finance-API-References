...
description: Класс представляет локальное изменение шрифта. См. определение элемента FONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 6850
url: /ru/net/aspose.finance.xbrl.dom.html/htmlfontelement/
---
## HTMLFontElement class

Класс представляет локальное изменение шрифта. См. определение элемента FONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
