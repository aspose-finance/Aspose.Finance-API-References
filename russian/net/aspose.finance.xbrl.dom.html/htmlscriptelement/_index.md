...
description: Класс представляет операторы сценария. См. определение элемента SCRIPT в HTML 4.01.
type: docs
weight: 7140
url: /ru/net/aspose.finance.xbrl.dom.html/htmlscriptelement/
---
## HTMLScriptElement class

Класс представляет операторы сценария. См. определение элемента SCRIPT в HTML 4.01.
