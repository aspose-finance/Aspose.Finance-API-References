...
description: Класс представляет собой список определений. См. определение элемента DL в HTML 4.01.
type: docs
weight: 6790
url: /ru/net/aspose.finance.xbrl.dom.html/htmldlistelement/
---
## HTMLDListElement class

Класс представляет собой список определений. См. определение элемента DL в HTML 4.01.
