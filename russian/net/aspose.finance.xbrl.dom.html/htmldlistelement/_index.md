...
description: Класс представляет список определений. См. определение элемента DL в HTML 4.01.
type: docs
weight: 6790
...
Класс представляет список определений. См. определение элемента DL в HTML 4.01.
