...
description: Класс представляет элемент списка. См. определение элемента LI в HTML 4.01.
type: docs
weight: 6970
url: /ru/net/aspose.finance.xbrl.dom.html/htmllielement/
---
## HTMLLIElement class

Класс представляет элемент списка. См. определение элемента LI в HTML 4.01.
