...
description: Класс представляет собой неупорядоченный список. См. определение элемента UL в HTML 4.01.
type: docs
weight: 7270
url: /ru/net/aspose.finance.xbrl.dom.html/htmlulistelement/
---
## HTMLUListElement class

Класс представляет собой неупорядоченный список. См. определение элемента UL в HTML 4.01.
