...
description: Класс представляет базовый URI документа. См. определение элемента BASE в HTML 4.01.
type: docs
weight: 6740
url: /ru/net/aspose.finance.xbrl.dom.html/htmlbaseelement/
---
## HTMLBaseElement class

Класс представляет базовый URI документа. См. определение элемента BASE в HTML 4.01.
