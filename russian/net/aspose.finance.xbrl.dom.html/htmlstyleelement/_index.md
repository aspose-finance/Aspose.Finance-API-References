...
description: Класс представляет информацию о стиле. См. определение элемента STYLE в HTML 4.01. .
type: docs
weight: 7160
url: /ru/net/aspose.finance.xbrl.dom.html/htmlstyleelement/
---
## HTMLStyleElement class

Класс представляет информацию о стиле. См. определение элемента STYLE в HTML 4.01. .
