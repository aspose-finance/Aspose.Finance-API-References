...
description: Класс представляет собой набор элементов параметров которые представляют предопределенные параметры для других элементов управления.
type: docs
weight: 6800
url: /ru/net/aspose.finance.xbrl.dom.html/htmldatalistelement/
---
## HTMLDataListElement class

Класс представляет собой набор элементов параметров, которые представляют предопределенные параметры для других элементов управления.
