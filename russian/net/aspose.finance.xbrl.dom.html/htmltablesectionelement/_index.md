...
description: Класс представляет элементы THEAD TFOOT и TBODY.
type: docs
weight: 7230
url: /ru/net/aspose.finance.xbrl.dom.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Класс представляет элементы THEAD, TFOOT и TBODY.
