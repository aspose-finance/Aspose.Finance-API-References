...
description: Класс представляет карту изображения на стороне клиента. См. определение элемента MAP в HTML 4.01.
type: docs
weight: 7010
url: /ru/net/aspose.finance.xbrl.dom.html/htmlmapelement/
---
## HTMLMapElement class

Класс представляет карту изображения на стороне клиента. См. определение элемента MAP в HTML 4.01.
