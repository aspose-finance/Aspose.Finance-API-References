...
description: Класс представляет htmlфрейм. См. определение элемента FRAME в HTML 4.01.
type: docs
weight: 6870
url: /ru/net/aspose.finance.xbrl.dom.html/htmlframeelement/
---
## HTMLFrameElement class

Класс представляет html-фрейм. См. определение элемента FRAME в HTML 4.01.
