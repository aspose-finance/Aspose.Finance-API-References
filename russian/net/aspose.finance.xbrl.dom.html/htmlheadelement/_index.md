...
description: Класс представляет информацию заголовка документа. См. определение элемента HEAD в HTML 4.01.
type: docs
weight: 6900
url: /ru/net/aspose.finance.xbrl.dom.html/htmlheadelement/
---
## HTMLHeadElement class

Класс представляет информацию заголовка документа. См. определение элемента HEAD в HTML 4.01.
