...
description: Класс указывает ссылку на внешний ресурс и определяет отношение этого документа к этому ресурсу или наоборот. См. определение элемента LINK в HTML 4.01 .
type: docs
weight: 7000
url: /ru/net/aspose.finance.xbrl.dom.html/htmllinkelement/
---
## HTMLLinkElement class

Класс указывает ссылку на внешний ресурс и определяет отношение этого документа к этому ресурсу (или наоборот). См. определение элемента LINK в HTML 4.01 .
