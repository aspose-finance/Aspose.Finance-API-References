...
description: Класс представляет собой многострочное текстовое поле. См. определение элемента TEXTAREA в HTML 4.01.
type: docs
weight: 7250
url: /ru/net/aspose.finance.xbrl.dom.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Класс представляет собой многострочное текстовое поле. См. определение элемента TEXTAREA в HTML 4.01.
