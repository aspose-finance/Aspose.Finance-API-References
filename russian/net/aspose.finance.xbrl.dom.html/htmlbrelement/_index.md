...
description: Класс представляет разрыв строки. См. определение элемента BR в HTML 4.01.
type: docs
weight: 6730
url: /ru/net/aspose.finance.xbrl.dom.html/htmlbrelement/
---
## HTMLBRElement class

Класс представляет разрыв строки. См. определение элемента BR в HTML 4.01.
