...
description: Класс представляет элемент COLGROUP. См. определение элемента COLGROUP в HTML 4.01.
type: docs
weight: 7200
url: /ru/net/aspose.finance.xbrl.dom.html/htmltablecolgroupelement/
---
## HTMLTableColGroupElement class

Класс представляет элемент COLGROUP. См. определение элемента COLGROUP в HTML 4.01.
