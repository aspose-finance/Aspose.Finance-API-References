...
description: Класс представляет встроенный Javaапплет. См. определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 6710
url: /ru/net/aspose.finance.xbrl.dom.html/htmlappletelement/
---
## HTMLAppletElement class

Класс представляет встроенный Java-апплет. См. определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01.
