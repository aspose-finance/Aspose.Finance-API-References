...
description: Класс представляет встроенный апплет Java. См. определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 6710
...
Класс представляет встроенный апплет Java. См. определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01.
