...
description: Класс представляет заголовок для группы FIELDSET. См. определение элемента LEGEND в HTML 4.01.
type: docs
weight: 6990
url: /ru/net/aspose.finance.xbrl.dom.html/htmllegendelement/
---
## HTMLLegendElement class

Класс представляет заголовок для группы FIELDSET. См. определение элемента LEGEND в HTML 4.01.
