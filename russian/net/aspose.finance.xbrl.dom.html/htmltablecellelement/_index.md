...
description: Класс используемый для представления элементов TH и TD. См. определение элемента TD в HTML 4.01.
type: docs
weight: 7180
url: /ru/net/aspose.finance.xbrl.dom.html/htmltablecellelement/
---
## HTMLTableCellElement class

Класс, используемый для представления элементов TH и TD. См. определение элемента TD в HTML 4.01.
