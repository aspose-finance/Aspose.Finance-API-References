...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlHiddenElement クラス. インライン xbrl 非表示要素を表すクラスです
type: docs
weight: 7380
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlhiddenelement/
---
## InlineXbrlHiddenElement class

インライン xbrl 非表示要素を表すクラスです。
