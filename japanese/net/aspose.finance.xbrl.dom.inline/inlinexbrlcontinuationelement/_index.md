...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlContinuationElement クラス. インライン xbrl 継続要素を表すクラスです
type: docs
weight: 7320
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlcontinuationelement/
---
## InlineXbrlContinuationElement class

インライン xbrl 継続要素を表すクラスです。
