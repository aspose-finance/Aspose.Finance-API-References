...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlNonNumericElement クラス. このクラスはインライン xbrl 非数値要素を表します
type: docs
weight: 7400
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlnonnumericelement/
---
## InlineXbrlNonNumericElement class

このクラスは、インライン xbrl 非数値要素を表します。
