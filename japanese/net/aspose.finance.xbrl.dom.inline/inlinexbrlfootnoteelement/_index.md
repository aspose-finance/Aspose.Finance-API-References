...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlFootnoteElement クラス. インライン xbrl 脚注要素を表すクラスです
type: docs
weight: 7350
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlfootnoteelement/
---
## InlineXbrlFootnoteElement class

インライン xbrl 脚注要素を表すクラスです。
