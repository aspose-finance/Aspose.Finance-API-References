...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlReferencesElement クラス. このクラスはインライン xbrl 参照要素を表します.
type: docs
weight: 7410
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlreferenceselement/
---
## InlineXbrlReferencesElement class

このクラスはインライン xbrl 参照要素を表します.
