...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlFractionElement クラス. インライン xbrl 分数要素を表すクラスです
type: docs
weight: 7360
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlfractionelement/
---
## InlineXbrlFractionElement class

インライン xbrl 分数要素を表すクラスです。
