...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlResourcesElement クラス. クラスはインライン xbrl リソース要素を表します
type: docs
weight: 7430
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlresourceselement/
---
## InlineXbrlResourcesElement class

クラスはインライン xbrl リソース要素を表します。
