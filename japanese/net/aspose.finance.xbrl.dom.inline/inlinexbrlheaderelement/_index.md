...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlHeaderElement クラス. このクラスはインライン xbrl ヘッダー要素を表します
type: docs
weight: 7370
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlheaderelement/
---
## InlineXbrlHeaderElement class

このクラスは、インライン xbrl ヘッダー要素を表します。
