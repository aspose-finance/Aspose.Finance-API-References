...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlExcludeElement クラス. インライン xbrl 除外要素を表すクラスです
type: docs
weight: 7340
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlexcludeelement/
---
## InlineXbrlExcludeElement class

インライン xbrl 除外要素を表すクラスです。
