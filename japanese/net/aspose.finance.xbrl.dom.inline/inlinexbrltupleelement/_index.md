...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlTupleElement クラス. インライン xbrl タプル要素を表すクラスです
type: docs
weight: 7440
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrltupleelement/
---
## InlineXbrlTupleElement class

インライン xbrl タプル要素を表すクラスです。
