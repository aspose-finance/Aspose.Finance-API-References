...
description: Aspose.Finance.Xbrl.Dom.Inline.InlineXbrlRelationshipElement クラス. クラスはインライン xbrl 関係要素を表します
type: docs
weight: 7420
url: /ja/net/aspose.finance.xbrl.dom.inline/inlinexbrlrelationshipelement/
---
## InlineXbrlRelationshipElement class

クラスは、インライン xbrl 関係要素を表します。
