...
description: Aspose.Finance.Ofx.Signup.EnrollTransactionResponse クラス. 登録トランザクション応答クラス.
type: docs
weight: 5660
url: /ja/net/aspose.finance.ofx.signup/enrolltransactionresponse/
---
...
| 名前 | 説明 |
| --- | --- |
| [EnrollTransactionResponse](enrolltransactionresponse/)() | の新しいインスタンスを初期化します`EnrollTransactionResponse`class. |
...
| [EnrollResponse](../../aspose.finance.ofx.signup/enrolltransactionresponse/enrollresponse/) { get; set; } | を取得または設定します[`EnrollResponse`](./enrollresponse/). |
| [OfxExtension](../../aspose.finance.ofx.signup/enrolltransactionresponse/ofxextension/) { get; set; } | を取得または設定します[`OfxExtensionType`](../../aspose.finance.ofx/ofxextensiontype/). |
...
* 名前空間 [Aspose.Finance.Ofx.Signup](../../aspose.finance.ofx.signup/)
* 組み立て [Aspose.Finance](../../)
