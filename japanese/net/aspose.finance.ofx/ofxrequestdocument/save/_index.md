...
description: OfxRequestDocument 方法. OFX ファイルを作成しディスクに保存します
type: docs
weight: 200
url: /ja/net/aspose.finance.ofx/ofxrequestdocument/save/
---
## Save(string, OfxVersionEnum) {#save_2}

OFX ファイルを作成し、ディスクに保存します。
...
| パラメータ | タイプ | 説明 |
| --- | --- | --- |
| fileName | String | 作成されたファイルの名前。 |
| ofxVersion | OfxVersionEnum | オフバージョン。 |

### 関連項目

* enum [OfxVersionEnum](../../ofxversionenum/)
* class [OfxRequestDocument](../)
* 名前空間 [Aspose.Finance.Ofx](../../ofxrequestdocument/)
* 組み立て [Aspose.Finance](../../../)
