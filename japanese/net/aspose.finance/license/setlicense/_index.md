...
type: docs
weight: 20
url: /ja/net/aspose.finance/license/setlicense/
---
...
2. Java アプリケーションの現在の作業ディレクトリ。

3. Aspose コンポーネント JAR ファイルを含むフォルダー。

4. クライアントの呼び出し JAR ファイルを含むフォルダー。
