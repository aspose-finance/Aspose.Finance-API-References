...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstanceMeasureElement クラス. クラスは xbrl インスタンス メジャー要素を表します
type: docs
weight: 7540
url: /ja/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstancemeasureelement/
---
## XbrlInstanceMeasureElement class

クラスは xbrl インスタンス メジャー要素を表します。
