...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstanceEntityElement クラス. クラスはxbrl インスタンス エンティティ要素を表します
type: docs
weight: 7530
url: /ja/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceentityelement/
---
## XbrlInstanceEntityElement class

クラスは、xbrl インスタンス エンティティ要素を表します。
...
* 名前空間 [Aspose.Finance.Xbrl.Dom.XbrlInstance](../../aspose.finance.xbrl.dom.xbrlinstance/)
* 組み立て [Aspose.Finance](../../)
