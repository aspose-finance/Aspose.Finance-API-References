...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstanceUnitElement クラス. クラスは xbrl インスタンス ユニット要素を表します.
type: docs
weight: 7560
url: /ja/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceunitelement/
---
## XbrlInstanceUnitElement class

クラスは xbrl インスタンス ユニット要素を表します.
