...
description: Aspose.Finance.Xbrl.Dom.XbrlInstance.XbrlInstancePeroidElement クラス. クラスは xbrl インスタンスの期間要素を表します.
type: docs
weight: 7550
url: /ja/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceperoidelement/
---
## XbrlInstancePeroidElement class

クラスは xbrl インスタンスの期間要素を表します.
