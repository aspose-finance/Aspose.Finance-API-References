---
title: Class ProfileTransactionResponse
second_title: Aspose.Finance for .NET API リファレンス
description: Aspose.Finance.Ofx.Profile.ProfileTransactionResponse クラス. プロファイル トランザクション応答クラス.
type: docs
weight: 4750
url: /ja/net/aspose.finance.ofx.profile/profiletransactionresponse/
---
...
| 名前 | 説明 |
| --- | --- |
| [ProfileTransactionResponse](profiletransactionresponse/)() | の新しいインスタンスを初期化します`ProfileTransactionResponse`class. |
...
| [OfxExtension](../../aspose.finance.ofx.profile/profiletransactionresponse/ofxextension/) { get; set; } | を取得または設定します[`OfxExtensionType`](../../aspose.finance.ofx/ofxextensiontype/). |
| [ProfileResponse](../../aspose.finance.ofx.profile/profiletransactionresponse/profileresponse/) { get; set; } | を取得または設定します[`ProfileResponse`](./profileresponse/). |
