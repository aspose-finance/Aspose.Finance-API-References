...
description: Aspose.Finance.Xbrl.Dom.XbrlLinkbase.XbrlLinkbaseArcroleRefElement クラス. このクラスはxbrl リンクベースの arcroleRef 要素を表します
type: docs
weight: 7570
url: /ja/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbasearcrolerefelement/
---
## XbrlLinkbaseArcroleRefElement class

このクラスは、xbrl リンクベースの arcroleRef 要素を表します。
