...
description: Aspose.Finance.Xbrl.Dom.XbrlLinkbase.XbrlLinkbaseLinkbaseRefElement クラス. クラスはxbrl リンクベース linkbaseRef 要素を表します
type: docs
weight: 7590
url: /ja/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaselinkbaserefelement/
---
## XbrlLinkbaseLinkbaseRefElement class

クラスは、xbrl リンクベース linkbaseRef 要素を表します。
