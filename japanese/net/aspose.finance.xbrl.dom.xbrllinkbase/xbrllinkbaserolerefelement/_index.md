...
description: Aspose.Finance.Xbrl.Dom.XbrlLinkbase.XbrlLinkbaseRoleRefElement クラス. クラスはxbrl リンクベースの roleRef 要素を表します
type: docs
weight: 7600
url: /ja/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaserolerefelement/
---
## XbrlLinkbaseRoleRefElement class

クラスは、xbrl リンクベースの roleRef 要素を表します。
