...
description: Aspose.Finance.Xbrl.Dom.XbrlLinkbase.XbrlLinkbaseSchemaRefElement クラス. クラスはxbrl リンクベースの schemaRef 要素を表します
type: docs
weight: 7610
url: /ja/net/aspose.finance.xbrl.dom.xbrllinkbase/xbrllinkbaseschemarefelement/
---
## XbrlLinkbaseSchemaRefElement class

クラスは、xbrl リンクベースの schemaRef 要素を表します。
...
* 名前空間 [Aspose.Finance.Xbrl.Dom.XbrlLinkbase](../../aspose.finance.xbrl.dom.xbrllinkbase/)
* 組み立て [Aspose.Finance](../../)
