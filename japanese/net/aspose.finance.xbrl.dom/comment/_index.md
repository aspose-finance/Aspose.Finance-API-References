...
description: Aspose.Finance.Xbrl.Dom.Comment クラス. CharacterData から継承しコメントの内容を表します
type: docs
weight: 6680
url: /ja/net/aspose.finance.xbrl.dom/comment/
---
## Comment class

CharacterData から継承し、コメントの内容を表します。
...
| override [NodeName](../../aspose.finance.xbrl.dom/comment/nodename/) { get; } | コメントのノード名を取得します。 |
