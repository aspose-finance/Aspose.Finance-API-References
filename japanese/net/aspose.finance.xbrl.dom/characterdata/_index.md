...
description: Aspose.Finance.Xbrl.Dom.CharacterData クラス. CharacterData はDOM 内の文字データにアクセスするための一連の属性とメソッドで Node を拡張します
type: docs
weight: 6670
url: /ja/net/aspose.finance.xbrl.dom/characterdata/
---
## CharacterData class
