...
description: Aspose.Finance.Xbrl.Dom.Text クラス. クラスはテキスト コンテンツを表します
type: docs
weight: 7490
url: /ja/net/aspose.finance.xbrl.dom/text/
---
## Text class
...
| override [NodeName](../../aspose.finance.xbrl.dom/text/nodename/) { get; } | このテキストの名前を取得します。 |
