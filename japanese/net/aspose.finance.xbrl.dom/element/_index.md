...
description: Aspose.Finance.Xbrl.Dom.Element クラス. Element インターフェイスはインライン xbrl ドキュメント内の要素を表します
type: docs
weight: 6700
url: /ja/net/aspose.finance.xbrl.dom/element/
---
## Element class

Element インターフェイスは、インライン xbrl ドキュメント内の要素を表します。
