...
description: Aspose.Finance.Xbrl.CalculationLinkbaseRef クラス. このクラスはリンクベース参照の計算に使用されます
type: docs
weight: 6550
url: /ja/net/aspose.finance.xbrl/calculationlinkbaseref/
---
## CalculationLinkbaseRef class

このクラスは、リンクベース参照の計算に使用されます。
...
| [Links](../../aspose.finance.xbrl/calculationlinkbaseref/links/) { get; } | のコレクションを取得します[`CalculationLink`](../calculationlink/). |
