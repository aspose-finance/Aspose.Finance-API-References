---
title: Class ReferenceLinkbaseRef
second_title: Aspose.Finance for .NET API リファレンス
description: Aspose.Finance.Xbrl.ReferenceLinkbaseRef クラス. このクラスはリンクベース参照を参照するために使用されます
type: docs
weight: 7980
url: /ja/net/aspose.finance.xbrl/referencelinkbaseref/
---
## ReferenceLinkbaseRef class

このクラスは、リンクベース参照を参照するために使用されます。
...
| [Links](../../aspose.finance.xbrl/referencelinkbaseref/links/) { get; } | のコレクションを取得します[`ReferenceLink`](../referencelink/). |
