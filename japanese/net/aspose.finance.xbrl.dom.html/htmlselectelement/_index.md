...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLSelectElement クラス. select 要素を表すクラスはオプションの選択を可能にします含まれているオプションはselect 要素を介してコレクションとして直接アクセスできます HTML 4.01. の SELECT 要素の定義を参照してください
type: docs
weight: 7180
url: /ja/net/aspose.finance.xbrl.dom.html/htmlselectelement/
---
## HTMLSelectElement class

select 要素を表すクラスは、オプションの選択を可能にします。含まれているオプションは、select 要素を介してコレクションとして直接アクセスできます。 HTML 4.01. の SELECT 要素の定義を参照してください。
