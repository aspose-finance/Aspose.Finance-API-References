...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLAnchorElement クラス. クラスはアンカー要素を表します HTML 4.01 の A 要素の定義を参照してください
type: docs
weight: 6730
url: /ja/net/aspose.finance.xbrl.dom.html/htmlanchorelement/
---
## HTMLAnchorElement class

クラスはアンカー要素を表します。 HTML 4.01 の A 要素の定義を参照してください。
