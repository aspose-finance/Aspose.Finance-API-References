...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLabelElement クラス. クラスはフォーム フィールド ラベル テキストを表します HTML 4.01 の LABEL 要素の定義を参照してください
type: docs
weight: 7010
url: /ja/net/aspose.finance.xbrl.dom.html/htmllabelelement/
---
## HTMLLabelElement class

クラスは、フォーム フィールド ラベル テキストを表します。 HTML 4.01 の LABEL 要素の定義を参照してください。
