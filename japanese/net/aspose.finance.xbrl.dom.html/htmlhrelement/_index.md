...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHRElement クラス. このクラスは水平罫線を表します HTML 4.01 の HR 要素の定義を参照してください
type: docs
weight: 6920
url: /ja/net/aspose.finance.xbrl.dom.html/htmlhrelement/
---
## HTMLHRElement class

このクラスは水平罫線を表します。 HTML 4.01 の HR 要素の定義を参照してください。
