...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLDataListElement クラス. クラスは他のコントロールの定義済みオプションを表すオプション要素のセットを表します
type: docs
weight: 6830
url: /ja/net/aspose.finance.xbrl.dom.html/htmldatalistelement/
---
## HTMLDataListElement class

クラスは、他のコントロールの定義済みオプションを表すオプション要素のセットを表します。
