...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTitleElement クラス. タイトル要素を表すクラスです HTML 4.01 の TITLE 要素の定義を参照してください
type: docs
weight: 7290
url: /ja/net/aspose.finance.xbrl.dom.html/htmltitleelement/
---
## HTMLTitleElement class

タイトル要素を表すクラスです。 HTML 4.01 の TITLE 要素の定義を参照してください。
