...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHeadElement クラス. 文書の先頭情報を表すクラスです HTML 4.01 の HEAD 要素の定義を参照してください
type: docs
weight: 6930
url: /ja/net/aspose.finance.xbrl.dom.html/htmlheadelement/
---
## HTMLHeadElement class

文書の先頭情報を表すクラスです。 HTML 4.01 の HEAD 要素の定義を参照してください。
