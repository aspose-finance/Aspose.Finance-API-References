...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBaseFontElement クラス. クラスは基本フォントを表します HTML 4.01 の BASEFONT 要素の定義を参照してくださいこの要素はHTML 4.01 で廃止されました
type: docs
weight: 6780
url: /ja/net/aspose.finance.xbrl.dom.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

クラスは基本フォントを表します。 HTML 4.01 の BASEFONT 要素の定義を参照してください。この要素は、HTML 4.01 で廃止されました。
