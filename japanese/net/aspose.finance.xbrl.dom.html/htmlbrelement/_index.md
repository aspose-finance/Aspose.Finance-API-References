...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBRElement クラス. クラスは改行を表します HTML 4.01 の BR 要素の定義を参照してください
type: docs
weight: 6760
url: /ja/net/aspose.finance.xbrl.dom.html/htmlbrelement/
---
## HTMLBRElement class

クラスは改行を表します。 HTML 4.01 の BR 要素の定義を参照してください。
