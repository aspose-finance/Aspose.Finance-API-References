...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLImageElement クラス. クラスは埋め込み画像を表します HTML 4.01 の IMG 要素の定義を参照してください
type: docs
weight: 6970
url: /ja/net/aspose.finance.xbrl.dom.html/htmlimageelement/
---
## HTMLImageElement class

クラスは埋め込み画像を表します。 HTML 4.01 の IMG 要素の定義を参照してください。
