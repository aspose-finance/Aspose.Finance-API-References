...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLOptionElement クラス. クラスは選択可能な選択肢を表します HTML 4.01 の OPTION 要素の定義を参照してください
type: docs
weight: 7120
url: /ja/net/aspose.finance.xbrl.dom.html/htmloptionelement/
---
## HTMLOptionElement class

クラスは選択可能な選択肢を表します。 HTML 4.01 の OPTION 要素の定義を参照してください。
