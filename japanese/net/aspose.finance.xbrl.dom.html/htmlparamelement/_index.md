...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLParamElement クラス. このクラスはOBJECT 要素に渡されるパラメーターを表します HTML 4.01 の PARAM 要素の定義を参照してください
type: docs
weight: 7140
url: /ja/net/aspose.finance.xbrl.dom.html/htmlparamelement/
---
## HTMLParamElement class

このクラスは、OBJECT 要素に渡されるパラメーターを表します。 HTML 4.01 の PARAM 要素の定義を参照してください。
