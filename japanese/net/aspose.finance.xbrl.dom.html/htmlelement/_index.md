...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLElement クラス. すべての HTML 要素クラスはこのクラスから派生します HTML コア属性のみを公開する要素はこのクラスによって表されますこれらの要素は次のとおりです special SUBSUPSPANBDOfont TTIBUSSTRIKEBIGSMALL フレーズ EMSTRONG DFNCODESAMPKBDVARCITEACRONYMABBR リスト DDDTNOFRAMESNOSCRIPTADDRESSCENTERT.
type: docs
weight: 6860
url: /ja/net/aspose.finance.xbrl.dom.html/htmlelement/
---
## HTMLElement class

すべての HTML 要素クラスは、このクラスから派生します。 HTML コア属性のみを公開する要素は、このクラスによって表されます。これらの要素は次のとおりです: special: SUB、SUP、SPAN、BDOfont: TT、I、B、U、S、STRIKE、BIG、SMALL フレーズ: EM、STRONG 、DFN、CODE、SAMP、KBD、VAR、CITE、ACRONYM、ABBR リスト: DD、DTNOFRAMES、NOSCRIPTADDRESS、CENTERT.
