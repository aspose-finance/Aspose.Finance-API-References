...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableColGroupElement クラス. クラスは COLGROUP 要素を表します HTML 4.01 の COLGROUP 要素の定義を参照してください
type: docs
weight: 7230
url: /ja/net/aspose.finance.xbrl.dom.html/htmltablecolgroupelement/
---
## HTMLTableColGroupElement class

クラスは COLGROUP 要素を表します。 HTML 4.01 の COLGROUP 要素の定義を参照してください。
