...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBaseElement クラス. クラスはドキュメント ベース URI を表します HTML 4.01 の BASE 要素の定義を参照してください
type: docs
weight: 6770
url: /ja/net/aspose.finance.xbrl.dom.html/htmlbaseelement/
---
## HTMLBaseElement class

クラスはドキュメント ベース URI を表します。 HTML 4.01 の BASE 要素の定義を参照してください。
