...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFrameSetElement クラス. このクラスはフレームのグリッドを表します HTML 4.01 の FRAMESET 要素の定義を参照してください
type: docs
weight: 6910
url: /ja/net/aspose.finance.xbrl.dom.html/htmlframesetelement/
---
## HTMLFrameSetElement class

このクラスはフレームのグリッドを表します。 HTML 4.01 の FRAMESET 要素の定義を参照してください。
