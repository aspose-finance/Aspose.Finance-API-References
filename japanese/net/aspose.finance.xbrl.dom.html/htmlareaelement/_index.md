...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLAreaElement クラス. このクラスはクライアント側のイメージ マップ領域の定義を表します HTML 4.01 の AREA 要素の定義を参照してください
type: docs
weight: 6750
url: /ja/net/aspose.finance.xbrl.dom.html/htmlareaelement/
---
## HTMLAreaElement class

このクラスは、クライアント側のイメージ マップ領域の定義を表します。 HTML 4.01 の AREA 要素の定義を参照してください。
