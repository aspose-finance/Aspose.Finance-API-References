...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLinkElement クラス. クラスは外部リソースへのリンクを指定しこのドキュメントとそのリソースとの関係 またはその逆 を定義します HTML 4.01 の LINK 要素の定義を参照してください
type: docs
weight: 7030
url: /ja/net/aspose.finance.xbrl.dom.html/htmllinkelement/
---
## HTMLLinkElement class

クラスは、外部リソースへのリンクを指定し、このドキュメントとそのリソースとの関係 (またはその逆) を定義します。 HTML 4.01 の LINK 要素の定義を参照してください。
