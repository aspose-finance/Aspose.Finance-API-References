...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLMetaElement クラス. クラスにはドキュメントに関する一般的なメタ情報が含まれています HTML 4.01 の META 要素の定義を参照してください
type: docs
weight: 7060
url: /ja/net/aspose.finance.xbrl.dom.html/htmlmetaelement/
---
## HTMLMetaElement class

クラスには、ドキュメントに関する一般的なメタ情報が含まれています。 HTML 4.01 の META 要素の定義を参照してください。
