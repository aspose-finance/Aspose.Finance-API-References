...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableColElement クラス. クラスは COL 要素を表します HTML 4.01 の COL 要素の定義を参照してください
type: docs
weight: 7220
url: /ja/net/aspose.finance.xbrl.dom.html/htmltablecolelement/
---
## HTMLTableColElement class

クラスは COL 要素を表します。 HTML 4.01 の COL 要素の定義を参照してください。
