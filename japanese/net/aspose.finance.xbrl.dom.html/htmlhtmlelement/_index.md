...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHtmlElement クラス. クラスは HTML ドキュメントのルートを表します HTML 4.01 の HTML 要素の定義を参照してください
type: docs
weight: 6950
url: /ja/net/aspose.finance.xbrl.dom.html/htmlhtmlelement/
---
## HTMLHtmlElement class

クラスは HTML ドキュメントのルートを表します。 HTML 4.01 の HTML 要素の定義を参照してください。
