...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLOListElement クラス. クラスは順序付きリストを表します HTML 4.01 の OL 要素の定義を参照してください
type: docs
weight: 7090
url: /ja/net/aspose.finance.xbrl.dom.html/htmlolistelement/
---
## HTMLOListElement class

クラスは順序付きリストを表します。 HTML 4.01 の OL 要素の定義を参照してください。
