...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableCellElement クラス. TH 要素と TD 要素を表すために使用されるクラス HTML 4.01 の TD 要素の定義を参照してください
type: docs
weight: 7210
url: /ja/net/aspose.finance.xbrl.dom.html/htmltablecellelement/
---
## HTMLTableCellElement class

TH 要素と TD 要素を表すために使用されるクラス。 HTML 4.01 の TD 要素の定義を参照してください。
