...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLHeadingElement クラス. クラスは H1 から H6 要素を表します HTML 4.01 の H1 要素の定義を参照してください
type: docs
weight: 6940
url: /ja/net/aspose.finance.xbrl.dom.html/htmlheadingelement/
---
## HTMLHeadingElement class

クラスは H1 から H6 要素を表します。 HTML 4.01 の H1 要素の定義を参照してください。
