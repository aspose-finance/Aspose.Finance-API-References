...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLDivElement クラス. このクラスは汎用ブロック コンテナーを表します HTML 4.01 の DIV 要素の定義を参照してください
type: docs
weight: 6850
url: /ja/net/aspose.finance.xbrl.dom.html/htmldivelement/
---
## HTMLDivElement class

このクラスは汎用ブロック コンテナーを表します。 HTML 4.01 の DIV 要素の定義を参照してください。
