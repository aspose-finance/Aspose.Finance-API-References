...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLModElement クラス. このクラスはドキュメントの一部に対する変更の通知を表します HTML 4.01 の INS 要素と DEL 要素の定義を参照してください
type: docs
weight: 7070
url: /ja/net/aspose.finance.xbrl.dom.html/htmlmodelement/
---
## HTMLModElement class

このクラスは、ドキュメントの一部に対する変更の通知を表します。 HTML 4.01 の INS 要素と DEL 要素の定義を参照してください。
