...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLQuoteElement クラス. クラスはQ および BLOCKQUOTE 要素を表します HTML 4.01 の Q 要素の定義を参照してください
type: docs
weight: 7160
url: /ja/net/aspose.finance.xbrl.dom.html/htmlquoteelement/
---
## HTMLQuoteElement class

クラスは、Q および BLOCKQUOTE 要素を表します。 HTML 4.01 の Q 要素の定義を参照してください。
