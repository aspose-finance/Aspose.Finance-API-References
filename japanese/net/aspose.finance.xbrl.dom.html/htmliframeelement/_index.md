...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLIFrameElement クラス. クラスはインライン サブウィンドウを表します HTML 4.01 の IFRAME 要素の定義を参照してください
type: docs
weight: 6960
url: /ja/net/aspose.finance.xbrl.dom.html/htmliframeelement/
---
## HTMLIFrameElement class

クラスはインライン サブウィンドウを表します。 HTML 4.01 の IFRAME 要素の定義を参照してください。
