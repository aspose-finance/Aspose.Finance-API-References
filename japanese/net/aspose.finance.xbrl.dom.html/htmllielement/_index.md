...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLIElement クラス. クラスはリスト項目を表します HTML 4.01 の LI 要素の定義を参照してください
type: docs
weight: 7000
url: /ja/net/aspose.finance.xbrl.dom.html/htmllielement/
---
## HTMLLIElement class

クラスはリスト項目を表します。 HTML 4.01 の LI 要素の定義を参照してください。
