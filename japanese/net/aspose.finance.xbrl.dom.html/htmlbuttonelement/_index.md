...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLButtonElement クラス. プッシュボタンを表すクラスです HTML 4.01 の BUTTON 要素の定義を参照してください
type: docs
weight: 6800
url: /ja/net/aspose.finance.xbrl.dom.html/htmlbuttonelement/
---
## HTMLButtonElement class

プッシュボタンを表すクラスです。 HTML 4.01 の BUTTON 要素の定義を参照してください。
