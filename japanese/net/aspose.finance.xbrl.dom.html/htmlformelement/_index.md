...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFormElement クラス. クラスにはコレクションや要素に似た動作が含まれます含まれているフォーム コントロールとフォーム要素の属性への直接アクセスを提供します HTML 4.01 の FORM 要素の定義を参照してください
type: docs
weight: 6890
url: /ja/net/aspose.finance.xbrl.dom.html/htmlformelement/
---
## HTMLFormElement class

クラスには、コレクションや要素に似た動作が含まれます。含まれているフォーム コントロールとフォーム要素の属性への直接アクセスを提供します。 HTML 4.01 の FORM 要素の定義を参照してください。
