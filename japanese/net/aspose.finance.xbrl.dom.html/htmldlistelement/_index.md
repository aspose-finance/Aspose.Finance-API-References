...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLDListElement クラス. クラスは定義リストを表します HTML 4.01 の DL 要素の定義を参照してください
type: docs
weight: 6820
url: /ja/net/aspose.finance.xbrl.dom.html/htmldlistelement/
---
## HTMLDListElement class

クラスは定義リストを表します。 HTML 4.01 の DL 要素の定義を参照してください。
