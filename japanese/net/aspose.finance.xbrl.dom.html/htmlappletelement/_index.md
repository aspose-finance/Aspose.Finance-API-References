...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLAppletElement クラス. クラスは組み込み Java アプレットを表します HTML 4.01 の APPLET 要素の定義を参照してくださいこの要素はHTML 4.01 で廃止されました
type: docs
weight: 6740
url: /ja/net/aspose.finance.xbrl.dom.html/htmlappletelement/
---
## HTMLAppletElement class

クラスは組み込み Java アプレットを表します。 HTML 4.01 の APPLET 要素の定義を参照してください。この要素は、HTML 4.01 で廃止されました。
