...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLDirectoryElement クラス. クラスはディレクトリリストを表します HTML 4.01 の DIR 要素の定義を参照してくださいこの要素はHTML 4.01 で廃止されました
type: docs
weight: 6840
url: /ja/net/aspose.finance.xbrl.dom.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

クラスはディレクトリリストを表します。 HTML 4.01 の DIR 要素の定義を参照してください。この要素は、HTML 4.01 で廃止されました。
