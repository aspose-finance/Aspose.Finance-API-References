...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLStyleElement クラス. クラスはスタイル情報を表します HTML 4.01. の STYLE 要素の定義を参照してください
type: docs
weight: 7190
url: /ja/net/aspose.finance.xbrl.dom.html/htmlstyleelement/
---
## HTMLStyleElement class

クラスはスタイル情報を表します。 HTML 4.01. の STYLE 要素の定義を参照してください。
