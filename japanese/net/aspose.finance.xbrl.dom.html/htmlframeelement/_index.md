...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFrameElement クラス. html フレームを表すクラスです HTML 4.01 の FRAME 要素の定義を参照してください
type: docs
weight: 6900
url: /ja/net/aspose.finance.xbrl.dom.html/htmlframeelement/
---
## HTMLFrameElement class

html フレームを表すクラスです。 HTML 4.01 の FRAME 要素の定義を参照してください。
