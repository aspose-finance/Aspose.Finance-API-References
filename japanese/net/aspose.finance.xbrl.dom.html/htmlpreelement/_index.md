...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLPreElement クラス. クラスは整形済みテキストを表します HTML 4.01 の PRE 要素の定義を参照してください
type: docs
weight: 7150
url: /ja/net/aspose.finance.xbrl.dom.html/htmlpreelement/
---
## HTMLPreElement class

クラスは整形済みテキストを表します。 HTML 4.01 の PRE 要素の定義を参照してください。
