...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLIsIndexElement クラス. このクラスは1 行のテキスト入力に使用されます HTML 4.01 の ISINDEX 要素の定義を参照してくださいこの要素はHTML 4.01. で廃止されました
type: docs
weight: 6990
url: /ja/net/aspose.finance.xbrl.dom.html/htmlisindexelement/
---
## HTMLIsIndexElement class

このクラスは、1 行のテキスト入力に使用されます。 HTML 4.01 の ISINDEX 要素の定義を参照してください。この要素は、HTML 4.01. で廃止されました。
