...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFontElement クラス. クラスはフォントのローカル変更を表します HTML 4.01 の FONT 要素の定義を参照してくださいこの要素はHTML 4.01 で廃止されました
type: docs
weight: 6880
url: /ja/net/aspose.finance.xbrl.dom.html/htmlfontelement/
---
## HTMLFontElement class

クラスは、フォントのローカル変更を表します。 HTML 4.01 の FONT 要素の定義を参照してください。この要素は、HTML 4.01 で廃止されました。
