...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableSectionElement クラス. このクラスはTHEADTFOOTおよび TBODY 要素を表します
type: docs
weight: 7260
url: /ja/net/aspose.finance.xbrl.dom.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

このクラスは、THEAD、TFOOT、および TBODY 要素を表します。
