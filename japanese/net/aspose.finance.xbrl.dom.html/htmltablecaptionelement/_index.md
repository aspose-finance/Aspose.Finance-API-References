...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTableCaptionElement クラス. クラスは表のキャプションを表します HTML 4.01 の CAPTION 要素の定義を参照してください
type: docs
weight: 7200
url: /ja/net/aspose.finance.xbrl.dom.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

クラスは表のキャプションを表します。 HTML 4.01 の CAPTION 要素の定義を参照してください。
