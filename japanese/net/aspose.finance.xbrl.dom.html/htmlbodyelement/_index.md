...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBodyElement クラス. クラスは HTML ドキュメントの本文を表しますこの要素はソース ドキュメントにタグが存在しない場合でも常に DOM API に存在します HTML 4.01 の BODY 要素の定義を参照してください
type: docs
weight: 6790
url: /ja/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

クラスは HTML ドキュメントの本文を表します。この要素は、ソース ドキュメントにタグが存在しない場合でも、常に DOM API に存在します。 HTML 4.01 の BODY 要素の定義を参照してください。
