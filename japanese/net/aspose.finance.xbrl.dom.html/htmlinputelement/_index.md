...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLInputElement クラス. クラスはフォーム コントロールを表しますページを表示している環境によってはファイル アップロードの入力タイプに対して value プロパティが読み取り専用になる場合があります パスワード入力タイプの場合返される実際の値は不正使用を防ぐためにマスクされる場合があります HTML 4.01 の INPUT 要素の定義を参照してください
type: docs
weight: 6980
url: /ja/net/aspose.finance.xbrl.dom.html/htmlinputelement/
---
## HTMLInputElement class

クラスはフォーム コントロールを表します。ページを表示している環境によっては、ファイル アップロードの入力タイプに対して value プロパティが読み取り専用になる場合があります。 「パスワード」入力タイプの場合、返される実際の値は、不正使用を防ぐためにマスクされる場合があります。 HTML 4.01 の INPUT 要素の定義を参照してください。
