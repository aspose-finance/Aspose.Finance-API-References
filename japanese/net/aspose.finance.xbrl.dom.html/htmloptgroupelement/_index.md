...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLOptGroupElement クラス. クラスはグループ オプションをまとめて論理的に細分化したものを表します HTML 4.01 の OPTGROUP 要素の定義を参照してください
type: docs
weight: 7110
url: /ja/net/aspose.finance.xbrl.dom.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

クラスは、グループ オプションをまとめて論理的に細分化したものを表します。 HTML 4.01 の OPTGROUP 要素の定義を参照してください。
