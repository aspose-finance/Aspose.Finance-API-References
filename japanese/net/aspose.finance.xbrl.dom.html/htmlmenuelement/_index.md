...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLMenuElement クラス. クラスはメニューリストを表します HTML 4.01 の MENU 要素の定義を参照してくださいこの要素はHTML 4.01 で廃止されました
type: docs
weight: 7050
url: /ja/net/aspose.finance.xbrl.dom.html/htmlmenuelement/
---
## HTMLMenuElement class

クラスはメニューリストを表します。 HTML 4.01 の MENU 要素の定義を参照してください。この要素は、HTML 4.01 で廃止されました。
