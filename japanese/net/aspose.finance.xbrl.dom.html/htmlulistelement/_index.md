...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLUListElement クラス. クラスは順序なしリストを表します HTML 4.01 の UL 要素の定義を参照してください
type: docs
weight: 7300
url: /ja/net/aspose.finance.xbrl.dom.html/htmlulistelement/
---
## HTMLUListElement class

クラスは順序なしリストを表します。 HTML 4.01 の UL 要素の定義を参照してください。
