...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLegendElement クラス. クラスはFIELDSET グループのキャプションを表します HTML 4.01 の LEGEND 要素の定義を参照してください
type: docs
weight: 7020
url: /ja/net/aspose.finance.xbrl.dom.html/htmllegendelement/
---
## HTMLLegendElement class

クラスは、FIELDSET グループのキャプションを表します。 HTML 4.01 の LEGEND 要素の定義を参照してください。
