...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLTextAreaElement クラス. このクラスは複数行テキスト フィールドを表します HTML 4.01 の TEXTAREA 要素の定義を参照してください
type: docs
weight: 7280
url: /ja/net/aspose.finance.xbrl.dom.html/htmltextareaelement/
---
## HTMLTextAreaElement class

このクラスは複数行テキスト フィールドを表します。 HTML 4.01 の TEXTAREA 要素の定義を参照してください。
