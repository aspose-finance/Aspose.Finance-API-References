...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLAddressElement クラス. アドレス要素を表すクラスです HTML 4.01 の ADDRESS 要素の定義を参照してください
type: docs
weight: 6720
url: /ja/net/aspose.finance.xbrl.dom.html/htmladdresselement/
---
## HTMLAddressElement class

アドレス要素を表すクラスです。 HTML 4.01 の ADDRESS 要素の定義を参照してください。
