...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLMapElement クラス. クラスはクライアント側のイメージ マップを表します HTML 4.01 の MAP 要素の定義を参照してください
type: docs
weight: 7040
url: /ja/net/aspose.finance.xbrl.dom.html/htmlmapelement/
---
## HTMLMapElement class

クラスは、クライアント側のイメージ マップを表します。 HTML 4.01 の MAP 要素の定義を参照してください。
