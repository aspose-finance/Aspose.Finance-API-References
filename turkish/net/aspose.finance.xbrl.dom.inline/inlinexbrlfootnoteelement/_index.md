...
description: Sınıf satır içi xbrl dipnot öğesini temsil eder.
type: docs
weight: 7320
url: /tr/net/aspose.finance.xbrl.dom.inline/inlinexbrlfootnoteelement/
---
## InlineXbrlFootnoteElement class

Sınıf, satır içi xbrl dipnot öğesini temsil eder.
