...
description: Sınıf satır içi xbrl kaynakları öğesini temsil eder.
type: docs
weight: 7400
url: /tr/net/aspose.finance.xbrl.dom.inline/inlinexbrlresourceselement/
---
## InlineXbrlResourcesElement class

Sınıf, satır içi xbrl kaynakları öğesini temsil eder.
