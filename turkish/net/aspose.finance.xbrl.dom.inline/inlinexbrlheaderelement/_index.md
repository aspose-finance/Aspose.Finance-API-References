...
description: Sınıf satır içi xbrl başlık öğesini temsil eder.
type: docs
weight: 7340
url: /tr/net/aspose.finance.xbrl.dom.inline/inlinexbrlheaderelement/
---
## InlineXbrlHeaderElement class

Sınıf, satır içi xbrl başlık öğesini temsil eder.
