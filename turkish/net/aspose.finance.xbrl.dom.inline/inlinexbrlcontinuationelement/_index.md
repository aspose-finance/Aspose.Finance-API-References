...
description: Sınıf satır içi xbrl devam öğesini temsil eder.
type: docs
weight: 7290
url: /tr/net/aspose.finance.xbrl.dom.inline/inlinexbrlcontinuationelement/
---
## InlineXbrlContinuationElement class

Sınıf, satır içi xbrl devam öğesini temsil eder.
