...
description: Sınıf XMLde işlemciye özel bilgileri belge metninde tutmanın bir yolu olarak kullanılan bir işleme talimatını temsil eder.
type: docs
weight: 7450
url: /tr/net/aspose.finance.xbrl.dom/processinginstruction/
---
## ProcessingInstruction class

Sınıf, XML'de işlemciye özel bilgileri belge metninde tutmanın bir yolu olarak kullanılan bir "işleme talimatını" temsil eder.
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename) { get; } | Bu işleme talimatının adını alır. |
