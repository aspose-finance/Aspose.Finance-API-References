...
description: CharacterData öğesinden devralır ve bir yorumun içeriğini temsil eder.
type: docs
weight: 6650
url: /tr/net/aspose.finance.xbrl.dom/comment/
---
## Comment class

CharacterData öğesinden devralır ve bir yorumun içeriğini temsil eder.
...
| override [NodeName](../../aspose.finance.xbrl.dom/comment/nodename) { get; } | Yorumun düğüm adını alır. |
