...
description: Sınıf xbrl örneği varlık öğesini temsil eder.
type: docs
weight: 7500
url: /tr/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceentityelement/
---
## XbrlInstanceEntityElement class

Sınıf, xbrl örneği varlık öğesini temsil eder.
...
* ad alanı [Aspose.Finance.Xbrl.Dom.XbrlInstance](../../aspose.finance.xbrl.dom.xbrlinstance)
