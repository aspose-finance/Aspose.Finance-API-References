...
description: Sınıf xbrl örnek dönemi öğesini temsil eder.
type: docs
weight: 7520
url: /tr/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceperoidelement/
---
## XbrlInstancePeroidElement class

Sınıf, xbrl örnek dönemi öğesini temsil eder.
