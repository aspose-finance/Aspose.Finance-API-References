...
description: Sınıf xbrl örneği ölçü öğesini temsil eder.
type: docs
weight: 7510
url: /tr/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstancemeasureelement/
---
## XbrlInstanceMeasureElement class

Sınıf, xbrl örneği ölçü öğesini temsil eder.
