...
description: Sınıf xbrl örnek birimi öğesini temsil eder.
type: docs
weight: 7530
url: /tr/net/aspose.finance.xbrl.dom.xbrlinstance/xbrlinstanceunitelement/
---
## XbrlInstanceUnitElement class

Sınıf, xbrl örnek birimi öğesini temsil eder.
