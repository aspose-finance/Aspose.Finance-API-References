...
description: Sınıf form alanı etiket metnini temsil eder. HTML 4.01deki LABEL öğesi tanımına bakın.
type: docs
weight: 6980
url: /tr/net/aspose.finance.xbrl.dom.html/htmllabelelement/
---
## HTMLLabelElement class

Sınıf, form alanı etiket metnini temsil eder. HTML 4.01'deki LABEL öğesi tanımına bakın.
