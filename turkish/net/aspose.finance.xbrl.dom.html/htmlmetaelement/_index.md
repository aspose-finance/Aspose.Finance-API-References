...
description: Sınıf belgeyle ilgili genel meta bilgileri içerir. HTML 4.01deki META öğesi tanımına bakın.
type: docs
weight: 7030
url: /tr/net/aspose.finance.xbrl.dom.html/htmlmetaelement/
---
## HTMLMetaElement class

Sınıf, belgeyle ilgili genel meta bilgileri içerir. HTML 4.01'deki META öğesi tanımına bakın.
