...
description: Sınıf gömülü bir Java uygulamasını temsil eder. HTML 4.01deki APPLET öğe tanımına bakın. Bu öğe HTML 4.01de kullanımdan kaldırılmıştır.
type: docs
weight: 6710
url: /tr/net/aspose.finance.xbrl.dom.html/htmlappletelement/
---
## HTMLAppletElement class

Sınıf, gömülü bir Java uygulamasını temsil eder. HTML 4.01'deki APPLET öğe tanımına bakın. Bu öğe HTML 4.01'de kullanımdan kaldırılmıştır.
