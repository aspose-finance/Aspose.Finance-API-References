...
description: Sınıf bir HTML belgesinin kökünü temsil eder. HTML 4.01deki HTML öğesi tanımına bakın.
type: docs
weight: 6920
url: /tr/net/aspose.finance.xbrl.dom.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Sınıf, bir HTML belgesinin kökünü temsil eder. HTML 4.01'deki HTML öğesi tanımına bakın.
