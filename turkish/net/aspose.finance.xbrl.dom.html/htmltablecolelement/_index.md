...
description: Sınıf COL öğesini temsil eder. HTML 4.01deki COL öğesi tanımına bakın.
type: docs
weight: 7190
url: /tr/net/aspose.finance.xbrl.dom.html/htmltablecolelement/
---
## HTMLTableColElement class

Sınıf, COL öğesini temsil eder. HTML 4.01'deki COL öğesi tanımına bakın.
