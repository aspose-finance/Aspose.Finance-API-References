...
description: Sınıf html çerçevesini temsil eder. HTML 4.01deki FRAME öğesi tanımına bakın.
type: docs
weight: 6870
url: /tr/net/aspose.finance.xbrl.dom.html/htmlframeelement/
---
## HTMLFrameElement class

Sınıf, html çerçevesini temsil eder. HTML 4.01'deki FRAME öğesi tanımına bakın.
