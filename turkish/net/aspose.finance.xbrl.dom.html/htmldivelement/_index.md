...
description: Sınıf genel blok kapsayıcısını temsil eder. HTML 4.01deki DIV öğesi tanımına bakın.
type: docs
weight: 6820
url: /tr/net/aspose.finance.xbrl.dom.html/htmldivelement/
---
## HTMLDivElement class

Sınıf, genel blok kapsayıcısını temsil eder. HTML 4.01'deki DIV öğesi tanımına bakın.
