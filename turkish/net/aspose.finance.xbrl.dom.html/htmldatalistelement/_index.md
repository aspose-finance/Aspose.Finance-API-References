...
description: Sınıf diğer kontroller için önceden tanımlanmış seçenekleri temsil eden bir dizi seçenek öğesini temsil eder.
type: docs
weight: 6800
url: /tr/net/aspose.finance.xbrl.dom.html/htmldatalistelement/
---
## HTMLDataListElement class

Sınıf, diğer kontroller için önceden tanımlanmış seçenekleri temsil eden bir dizi seçenek öğesini temsil eder.
