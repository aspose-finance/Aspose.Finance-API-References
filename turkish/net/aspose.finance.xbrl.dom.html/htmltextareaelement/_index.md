...
description: Sınıf Çok satırlı metin alanını temsil eder. HTML 4.01deki TEXTAREA öğesi tanımına bakın.
type: docs
weight: 7250
url: /tr/net/aspose.finance.xbrl.dom.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Sınıf, Çok satırlı metin alanını temsil eder. HTML 4.01'deki TEXTAREA öğesi tanımına bakın.
