...
description: Sınıf tablodaki bir satırı temsil eder. HTML 4.01deki TR öğe tanımına bakın.
type: docs
weight: 7220
url: /tr/net/aspose.finance.xbrl.dom.html/htmltablerowelement/
---
## HTMLTableRowElement class

Sınıf, tablodaki bir satırı temsil eder. HTML 4.01'deki TR öğe tanımına bakın.
