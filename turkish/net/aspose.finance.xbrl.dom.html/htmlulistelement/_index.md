...
description: Sınıf sırasız listeyi temsil eder. HTML 4.01deki UL öğesi tanımına bakın.
type: docs
weight: 7270
url: /tr/net/aspose.finance.xbrl.dom.html/htmlulistelement/
---
## HTMLUListElement class

Sınıf, sırasız listeyi temsil eder. HTML 4.01'deki UL öğesi tanımına bakın.
