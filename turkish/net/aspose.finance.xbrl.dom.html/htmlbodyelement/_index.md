...
description: Sınıf HTML belge gövdesini temsil eder. Bu öğe etiketler kaynak belgede olmasa bile her zaman DOM APIsinde bulunur. HTML 4.01deki BODY öğesi tanımına bakın.
type: docs
weight: 6760
url: /tr/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

Sınıf, HTML belge gövdesini temsil eder. Bu öğe, etiketler kaynak belgede olmasa bile her zaman DOM API'sinde bulunur. HTML 4.01'deki BODY öğesi tanımına bakın.
