...
description: Sınıf tablo başlığını temsil eder. HTML 4.01deki CAPTION öğesi tanımına bakın.
type: docs
weight: 7170
url: /tr/net/aspose.finance.xbrl.dom.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Sınıf, tablo başlığını temsil eder. HTML 4.01'deki CAPTION öğesi tanımına bakın.
