...
description: Sınıf bağlantı öğesini temsil eder. HTML 4.01deki A öğesi tanımına bakın.
type: docs
weight: 6700
url: /tr/net/aspose.finance.xbrl.dom.html/htmlanchorelement/
---
## HTMLAnchorElement class

Sınıf, bağlantı öğesini temsil eder. HTML 4.01'deki A öğesi tanımına bakın.
