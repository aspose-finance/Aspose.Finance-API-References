...
description: Sınıf harici bir kaynağa bir bağlantı belirtir ve bu belgenin o kaynakla ilişkisini tanımlar veya tam tersi. HTML 4.01deki LINK öğe tanımına bakın
type: docs
weight: 7000
url: /tr/net/aspose.finance.xbrl.dom.html/htmllinkelement/
---
## HTMLLinkElement class

Sınıf, harici bir kaynağa bir bağlantı belirtir ve bu belgenin o kaynakla ilişkisini tanımlar (veya tam tersi). HTML 4.01'deki LINK öğe tanımına bakın
