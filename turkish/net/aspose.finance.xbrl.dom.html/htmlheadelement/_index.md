...
description: Sınıf belge başlığı bilgilerini temsil eder. HTML 4.01deki HEAD öğesi tanımına bakın.
type: docs
weight: 6900
url: /tr/net/aspose.finance.xbrl.dom.html/htmlheadelement/
---
## HTMLHeadElement class

Sınıf, belge başlığı bilgilerini temsil eder. HTML 4.01'deki HEAD öğesi tanımına bakın.
