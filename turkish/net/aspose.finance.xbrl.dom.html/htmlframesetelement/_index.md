...
description: Bu sınıf bir çerçeve ızgarasını temsil eder. HTML 4.01deki FRAMESET öğe tanımına bakın.
type: docs
weight: 6880
url: /tr/net/aspose.finance.xbrl.dom.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Bu sınıf, bir çerçeve ızgarasını temsil eder. HTML 4.01'deki FRAMESET öğe tanımına bakın.
