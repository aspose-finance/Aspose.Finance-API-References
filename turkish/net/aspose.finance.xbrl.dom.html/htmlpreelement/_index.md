...
description: Sınıf önceden biçimlendirilmiş metni temsil eder. HTML 4.01deki PRE öğesi tanımına bakın.
type: docs
weight: 7120
url: /tr/net/aspose.finance.xbrl.dom.html/htmlpreelement/
---
## HTMLPreElement class

Sınıf, önceden biçimlendirilmiş metni temsil eder. HTML 4.01'deki PRE öğesi tanımına bakın.
