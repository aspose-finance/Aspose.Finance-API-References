...
description: Sınıf adres öğesini temsil eder. HTML 4.01deki ADDRESS öğesi tanımına bakın.
type: docs
weight: 6690
url: /tr/net/aspose.finance.xbrl.dom.html/htmladdresselement/
---
## HTMLAddressElement class

Sınıf, adres öğesini temsil eder. HTML 4.01'deki ADDRESS öğesi tanımına bakın.
