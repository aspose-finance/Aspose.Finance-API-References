...
description: TH ve TD öğelerini temsil etmek için kullanılan sınıf. HTML 4.01deki TD öğesi tanımına bakın.
type: docs
weight: 7180
url: /tr/net/aspose.finance.xbrl.dom.html/htmltablecellelement/
---
## HTMLTableCellElement class

TH ve TD öğelerini temsil etmek için kullanılan sınıf. HTML 4.01'deki TD öğesi tanımına bakın.
