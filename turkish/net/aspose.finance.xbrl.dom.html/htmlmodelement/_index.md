...
description: Sınıf bir belgenin bir bölümünde yapılan değişiklik bildirimini temsil eder. HTML 4.01deki INS ve DEL öğesi tanımlarına bakın.
type: docs
weight: 7040
url: /tr/net/aspose.finance.xbrl.dom.html/htmlmodelement/
---
## HTMLModElement class

Sınıf, bir belgenin bir bölümünde yapılan değişiklik bildirimini temsil eder. HTML 4.01'deki INS ve DEL öğesi tanımlarına bakın.
