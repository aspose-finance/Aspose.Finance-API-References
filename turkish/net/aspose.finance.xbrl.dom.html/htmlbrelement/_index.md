...
description: Sınıf bir satır sonunu temsil eder. HTML 4.01deki BR öğesi tanımına bakın.
type: docs
weight: 6730
url: /tr/net/aspose.finance.xbrl.dom.html/htmlbrelement/
---
## HTMLBRElement class

Sınıf, bir satır sonunu temsil eder. HTML 4.01'deki BR öğesi tanımına bakın.
