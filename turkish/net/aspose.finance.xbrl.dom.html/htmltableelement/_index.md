...
description: Sınıf bir tabloyu temsil eder. HTML 4.01deki TABLE öğesi tanımına bakın.
type: docs
weight: 7210
url: /tr/net/aspose.finance.xbrl.dom.html/htmltableelement/
---
## HTMLTableElement class

Sınıf, bir tabloyu temsil eder. HTML 4.01'deki TABLE öğesi tanımına bakın.
