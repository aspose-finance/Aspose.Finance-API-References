...
description: Sınıf H1 ila H6 öğelerini temsil eder. HTML 4.01deki H1 öğesi tanımına bakın.
type: docs
weight: 6910
url: /tr/net/aspose.finance.xbrl.dom.html/htmlheadingelement/
---
## HTMLHeadingElement class

Sınıf, H1 ila H6 öğelerini temsil eder. HTML 4.01'deki H1 öğesi tanımına bakın.
