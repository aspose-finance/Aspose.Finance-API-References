...
description: Form denetimlerini mantıksal gruplar halinde düzenler. HTML 4.01deki FIELDSET öğe tanımına bakın.
type: docs
weight: 6840
url: /tr/net/aspose.finance.xbrl.dom.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Form denetimlerini mantıksal gruplar halinde düzenler. HTML 4.01'deki FIELDSET öğe tanımına bakın.
