...
description: Bu sınıf yatay bir kuralı temsil eder. HTML 4.01deki İK öğesi tanımına bakın.
type: docs
weight: 6890
url: /tr/net/aspose.finance.xbrl.dom.html/htmlhrelement/
---
## HTMLHRElement class

Bu sınıf, yatay bir kuralı temsil eder. HTML 4.01'deki İK öğesi tanımına bakın.
