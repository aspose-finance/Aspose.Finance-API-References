...
description: Sınıf belge tabanı URIsini temsil eder. HTML 4.01deki BASE öğe tanımına bakın.
type: docs
weight: 6740
url: /tr/net/aspose.finance.xbrl.dom.html/htmlbaseelement/
---
## HTMLBaseElement class

Sınıf, belge tabanı URI'sini temsil eder. HTML 4.01'deki BASE öğe tanımına bakın.
