...
description: Sınıf tanım listesini temsil eder. HTML 4.01deki DL öğesi tanımına bakın.
type: docs
weight: 6790
url: /tr/net/aspose.finance.xbrl.dom.html/htmldlistelement/
---
## HTMLDListElement class

Sınıf, tanım listesini temsil eder. HTML 4.01'deki DL öğesi tanımına bakın.
