...
description: Sınıf bir koleksiyona ve bir öğeye benzer davranışları kapsar. Form öğesinin niteliklerinin yanı sıra içerilen form kontrollerine doğrudan erişim sağlar. HTML 4.01deki FORM öğesi tanımına bakın.
type: docs
weight: 6860
url: /tr/net/aspose.finance.xbrl.dom.html/htmlformelement/
---
## HTMLFormElement class

Sınıf, bir koleksiyona ve bir öğeye benzer davranışları kapsar. Form öğesinin niteliklerinin yanı sıra içerilen form kontrollerine doğrudan erişim sağlar. HTML 4.01'deki FORM öğesi tanımına bakın.
