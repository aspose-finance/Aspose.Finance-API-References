...
description: Sınıf sıralı listeyi temsil eder. HTML 4.01deki OL öğesi tanımına bakın.
type: docs
weight: 7060
url: /tr/net/aspose.finance.xbrl.dom.html/htmlolistelement/
---
## HTMLOListElement class

Sınıf, sıralı listeyi temsil eder. HTML 4.01'deki OL öğesi tanımına bakın.
