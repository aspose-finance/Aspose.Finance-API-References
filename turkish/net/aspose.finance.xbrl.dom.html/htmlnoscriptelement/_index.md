...
description: Sınıf kod deyimlerini temsil eder. HTML 4.01deki NOSCRIPT öğe tanımına bakın.
type: docs
weight: 7050
url: /tr/net/aspose.finance.xbrl.dom.html/htmlnoscriptelement/
---
## HTMLNoScriptElement class

Sınıf, kod deyimlerini temsil eder. HTML 4.01'deki NOSCRIPT öğe tanımına bakın.
