...
description: Bu sınıf tek satırlık metin girişi için kullanılır. HTML 4.01deki ISINDEX öğe tanımına bakın. Bu öğe HTML 4.01. de kullanımdan kaldırılmıştır.
type: docs
weight: 6960
url: /tr/net/aspose.finance.xbrl.dom.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Bu sınıf, tek satırlık metin girişi için kullanılır. HTML 4.01'deki ISINDEX öğe tanımına bakın. Bu öğe, HTML 4.01. 'de kullanımdan kaldırılmıştır.
