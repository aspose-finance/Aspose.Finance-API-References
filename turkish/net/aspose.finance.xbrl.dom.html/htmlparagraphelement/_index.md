...
description: Sınıf paragrafları temsil eder. HTML 4.01deki P öğesi tanımına bakın.
type: docs
weight: 7100
url: /tr/net/aspose.finance.xbrl.dom.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Sınıf, paragrafları temsil eder. HTML 4.01'deki P öğesi tanımına bakın.
