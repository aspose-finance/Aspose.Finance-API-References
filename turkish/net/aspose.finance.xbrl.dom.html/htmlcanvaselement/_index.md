...
description: Sınıf tuval öğelerinin düzenini ve sunumunu değiştirmek için özellikler ve yöntemler sağlar.
type: docs
weight: 6780
url: /tr/net/aspose.finance.xbrl.dom.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Sınıf, tuval öğelerinin düzenini ve sunumunu değiştirmek için özellikler ve yöntemler sağlar.
