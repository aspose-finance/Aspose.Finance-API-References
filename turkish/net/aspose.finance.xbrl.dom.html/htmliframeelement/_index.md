...
description: Sınıf satır içi alt pencereleri temsil eder. HTML 4.01deki IFRAME öğesi tanımına bakın.
type: docs
weight: 6930
url: /tr/net/aspose.finance.xbrl.dom.html/htmliframeelement/
---
## HTMLIFrameElement class

Sınıf, satır içi alt pencereleri temsil eder. HTML 4.01'deki IFRAME öğesi tanımına bakın.
