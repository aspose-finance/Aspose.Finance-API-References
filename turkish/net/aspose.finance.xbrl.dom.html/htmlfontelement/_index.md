...
description: Sınıf yazı tipinde yerel değişikliği temsil eder. HTML 4.01deki FONT öğesi tanımına bakın. Bu öğe HTML 4.01de kullanımdan kaldırılmıştır.
type: docs
weight: 6850
url: /tr/net/aspose.finance.xbrl.dom.html/htmlfontelement/
---
## HTMLFontElement class

Sınıf, yazı tipinde yerel değişikliği temsil eder. HTML 4.01'deki FONT öğesi tanımına bakın. Bu öğe HTML 4.01'de kullanımdan kaldırılmıştır.
