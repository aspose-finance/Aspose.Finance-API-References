...
description: Sınıf dizin listesini temsil eder. HTML 4.01deki DIR öğesi tanımına bakın. Bu öğe HTML 4.01de kullanımdan kaldırılmıştır.
type: docs
weight: 6810
url: /tr/net/aspose.finance.xbrl.dom.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Sınıf, dizin listesini temsil eder. HTML 4.01'deki DIR öğesi tanımına bakın. Bu öğe HTML 4.01'de kullanımdan kaldırılmıştır.
