...
description: Sınıf OBJECT öğesine beslenen parametreleri temsil eder. HTML 4.01deki PARAM öğesi tanımına bakın.
type: docs
weight: 7110
url: /tr/net/aspose.finance.xbrl.dom.html/htmlparamelement/
---
## HTMLParamElement class

Sınıf, OBJECT öğesine beslenen parametreleri temsil eder. HTML 4.01'deki PARAM öğesi tanımına bakın.
