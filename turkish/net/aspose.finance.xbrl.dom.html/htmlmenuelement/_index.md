...
description: Sınıf menü listesini temsil eder. HTML 4.01deki MENU öğesi tanımına bakın. Bu öğe HTML 4.01de kullanımdan kaldırılmıştır.
type: docs
weight: 7020
url: /tr/net/aspose.finance.xbrl.dom.html/htmlmenuelement/
---
## HTMLMenuElement class

Sınıf, menü listesini temsil eder. HTML 4.01'deki MENU öğesi tanımına bakın. Bu öğe HTML 4.01'de kullanımdan kaldırılmıştır.
