...
description: Sınıf kod deyimlerini temsil eder. HTML 4.01deki SCRIPT öğesi tanımına bakın.
type: docs
weight: 7140
url: /tr/net/aspose.finance.xbrl.dom.html/htmlscriptelement/
---
## HTMLScriptElement class

Sınıf, kod deyimlerini temsil eder. HTML 4.01'deki SCRIPT öğesi tanımına bakın.
