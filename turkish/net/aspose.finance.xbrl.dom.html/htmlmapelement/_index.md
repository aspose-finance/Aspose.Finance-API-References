...
description: Sınıf istemci tarafı görüntü haritasını temsil eder. HTML 4.01deki MAP öğesi tanımına bakın.
type: docs
weight: 7010
url: /tr/net/aspose.finance.xbrl.dom.html/htmlmapelement/
---
## HTMLMapElement class

Sınıf, istemci tarafı görüntü haritasını temsil eder. HTML 4.01'deki MAP öğesi tanımına bakın.
