...
description: Sınıf bir FIELDSET gruplaması için bir başlığı temsil eder. HTML 4.01deki LEGEND öğe tanımına bakın.
type: docs
weight: 6990
url: /tr/net/aspose.finance.xbrl.dom.html/htmllegendelement/
---
## HTMLLegendElement class

Sınıf, bir FIELDSET gruplaması için bir başlığı temsil eder. HTML 4.01'deki LEGEND öğe tanımına bakın.
