...
description: Sınıf form kontrolünü temsil eder. Sayfanın görüntülendiği ortama bağlı olarak value özelliği dosya yükleme giriş türü için salt okunur olabilir. Parola giriş türü için yetkisiz kullanımı önlemek için döndürülen gerçek değer maskelenebilir. HTML 4.01deki INPUT öğesi tanımına bakın.
type: docs
weight: 6950
url: /tr/net/aspose.finance.xbrl.dom.html/htmlinputelement/
---
## HTMLInputElement class

Sınıf, form kontrolünü temsil eder. Sayfanın görüntülendiği ortama bağlı olarak, value özelliği dosya yükleme giriş türü için salt okunur olabilir. "Parola" giriş türü için, yetkisiz kullanımı önlemek için döndürülen gerçek değer maskelenebilir. HTML 4.01'deki INPUT öğesi tanımına bakın.
