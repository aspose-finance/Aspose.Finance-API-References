...
description: Sınıf genel gömülü nesneyi temsil eder. Prensipte nesne öğesindeki tüm özellikler okumayazmadır ancak bazı ortamlarda temel alınan nesne somutlaştırıldıktan sonra bazı özellikler salt okunur olabilir. HTML 4.01deki NESNE öğesi tanımına bakın.
type: docs
weight: 7070
url: /tr/net/aspose.finance.xbrl.dom.html/htmlobjectelement/
---
## HTMLObjectElement class

Sınıf, genel gömülü nesneyi temsil eder. Prensipte, nesne öğesindeki tüm özellikler okuma-yazmadır, ancak bazı ortamlarda, temel alınan nesne somutlaştırıldıktan sonra bazı özellikler salt okunur olabilir. HTML 4.01'deki NESNE öğesi tanımına bakın.
