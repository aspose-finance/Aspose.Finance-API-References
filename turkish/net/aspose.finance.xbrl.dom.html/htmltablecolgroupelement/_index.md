...
description: Sınıf COLGROUP öğesini temsil eder. HTML 4.01deki COLGROUP öğe tanımına bakın.
type: docs
weight: 7200
url: /tr/net/aspose.finance.xbrl.dom.html/htmltablecolgroupelement/
---
## HTMLTableColGroupElement class

Sınıf, COLGROUP öğesini temsil eder. HTML 4.01'deki COLGROUP öğe tanımına bakın.
