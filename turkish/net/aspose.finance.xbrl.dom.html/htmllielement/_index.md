...
description: Sınıf liste öğesini temsil eder. HTML 4.01deki LI öğesi tanımına bakın.
type: docs
weight: 6970
url: /tr/net/aspose.finance.xbrl.dom.html/htmllielement/
---
## HTMLLIElement class

Sınıf, liste öğesini temsil eder. HTML 4.01'deki LI öğesi tanımına bakın.
