...
description: Sınıf basma düğmesini temsil eder. HTML 4.01deki BUTTON eleman tanımına bakın.
type: docs
weight: 6770
url: /tr/net/aspose.finance.xbrl.dom.html/htmlbuttonelement/
---
## HTMLButtonElement class

Sınıf, basma düğmesini temsil eder. HTML 4.01'deki BUTTON eleman tanımına bakın.
