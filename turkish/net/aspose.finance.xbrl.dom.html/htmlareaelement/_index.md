...
description: Sınıf istemci tarafı görüntü eşleme alanı tanımını temsil eder. HTML 4.01deki AREA öğesi tanımına bakın.
type: docs
weight: 6720
url: /tr/net/aspose.finance.xbrl.dom.html/htmlareaelement/
---
## HTMLAreaElement class

Sınıf, istemci tarafı görüntü eşleme alanı tanımını temsil eder. HTML 4.01'deki AREA öğesi tanımına bakın.
