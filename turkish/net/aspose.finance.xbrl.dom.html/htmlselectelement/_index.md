...
description: Sınıf seçme öğesini temsil eder bir seçeneğin seçimine izin verir. İçerilen seçeneklere koleksiyon olarak select öğesi aracılığıyla doğrudan erişilebilir. HTML 4.01. içindeki SELECT öğe tanımına bakın
type: docs
weight: 7150
url: /tr/net/aspose.finance.xbrl.dom.html/htmlselectelement/
---
## HTMLSelectElement class

Sınıf, seçme öğesini temsil eder, bir seçeneğin seçimine izin verir. İçerilen seçeneklere, koleksiyon olarak select öğesi aracılığıyla doğrudan erişilebilir. HTML 4.01. içindeki SELECT öğe tanımına bakın
