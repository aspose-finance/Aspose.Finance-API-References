...
description: Sınıf Q ve BLOCKQUOTE öğelerini temsil eder. HTML 4.01deki Q öğesi tanımına bakın.
type: docs
weight: 7130
url: /tr/net/aspose.finance.xbrl.dom.html/htmlquoteelement/
---
## HTMLQuoteElement class

Sınıf, Q ve BLOCKQUOTE öğelerini temsil eder. HTML 4.01'deki Q öğesi tanımına bakın.
