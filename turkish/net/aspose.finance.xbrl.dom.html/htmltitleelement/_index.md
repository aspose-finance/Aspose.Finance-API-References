...
description: Sınıf başlık öğesini temsil eder. HTML 4.01deki TITLE öğesi tanımına bakın.
type: docs
weight: 7260
url: /tr/net/aspose.finance.xbrl.dom.html/htmltitleelement/
---
## HTMLTitleElement class

Sınıf, başlık öğesini temsil eder. HTML 4.01'deki TITLE öğesi tanımına bakın.
