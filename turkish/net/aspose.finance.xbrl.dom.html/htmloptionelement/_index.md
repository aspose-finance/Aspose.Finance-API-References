...
description: Sınıf seçilebilir bir seçimi temsil eder. HTML 4.01deki OPTION öğesi tanımına bakın.
type: docs
weight: 7090
url: /tr/net/aspose.finance.xbrl.dom.html/htmloptionelement/
---
## HTMLOptionElement class

Sınıf, seçilebilir bir seçimi temsil eder. HTML 4.01'deki OPTION öğesi tanımına bakın.
