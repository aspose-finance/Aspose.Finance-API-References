...
type: docs
weight: 70
url: /tr/python-net/aspose.finance.xbrl.dom/namednodemap/set_named_item_ns/
is_root: false
---

## set_named_item_ns(item) {#Attr}
...
```python
def set_named_item_ns(self, item):
    ...
```
...
| :- | :- | :- |
| item | [Attr](/finance/python-net/aspose.finance.xbrl.dom/attr) | The attribute. |
