...
description: La classe rappresenta una istruzione di elaborazione utilizzata in XML come un modo per mantenere le informazioni specifiche del processore nel testo del documento.
type: docs
weight: 7450
url: /it/net/aspose.finance.xbrl.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename) { get; } | Ottiene il nome di questa istruzione di elaborazione. |
