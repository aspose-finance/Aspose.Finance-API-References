...
description: Eredita da CharacterData e rappresenta il contenuto di un commento.
type: docs
weight: 6650
url: /it/net/aspose.finance.xbrl.dom/comment/
---
## Comment class

Eredita da CharacterData e rappresenta il contenuto di un commento.
...
| override [NodeName](../../aspose.finance.xbrl.dom/comment/nodename) { get; } | Ottiene il nome del nodo del commento. |
