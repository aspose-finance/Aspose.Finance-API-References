...
description: La clase representa una instrucción de procesamiento utilizada en XML como una forma de mantener información específica del procesador en el texto del documento.
type: docs
weight: 7450
url: /es/net/aspose.finance.xbrl.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename) { get; } | Obtiene el nombre de esta instrucción de procesamiento. |
