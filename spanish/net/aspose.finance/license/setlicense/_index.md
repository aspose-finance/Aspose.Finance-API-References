...
type: docs
weight: 20
url: /es/net/aspose.finance/license/setlicense/
---
...
2. El directorio de trabajo actual de la aplicación java.

3. La carpeta que contiene el archivo JAR del componente Aspose.

4. La carpeta que contiene el archivo JAR de llamada del cliente.
...
* espacio de nombres [Aspose.Finance](../../license)
