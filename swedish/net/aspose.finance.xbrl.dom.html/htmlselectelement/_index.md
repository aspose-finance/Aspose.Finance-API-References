...
description: Klassen representerar select element tillåter val av ett alternativ. De inneslutna alternativen kan nås direkt via selectelementet som en samling. Se SELECTelementdefinitionen i HTML 4.01.
type: docs
weight: 7150
url: /sv/net/aspose.finance.xbrl.dom.html/htmlselectelement/
---
## HTMLSelectElement class

Klassen representerar select element tillåter val av ett alternativ. De inneslutna alternativen kan nås direkt via select-elementet som en samling. Se SELECT-elementdefinitionen i HTML 4.01.
