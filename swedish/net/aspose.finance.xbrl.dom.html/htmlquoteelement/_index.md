...
description: Klassen representerar för Q och BLOCKQUOTEelementen. Se Qelementdefinitionen i HTML 4.01.
type: docs
weight: 7130
url: /sv/net/aspose.finance.xbrl.dom.html/htmlquoteelement/
---
## HTMLQuoteElement class

Klassen representerar för Q- och BLOCKQUOTE-elementen. Se Q-elementdefinitionen i HTML 4.01.
