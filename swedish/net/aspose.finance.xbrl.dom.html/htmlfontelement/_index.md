...
description: Klassen representerar lokal ändring av teckensnitt. Se FONTelementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
type: docs
weight: 6850
url: /sv/net/aspose.finance.xbrl.dom.html/htmlfontelement/
---
## HTMLFontElement class

Klassen representerar lokal ändring av teckensnitt. Se FONT-elementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
