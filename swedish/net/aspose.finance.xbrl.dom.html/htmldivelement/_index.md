...
description: Klassen representerar en generisk blockbehållare. Se DIVelementdefinitionen i HTML 4.01.
type: docs
weight: 6820
url: /sv/net/aspose.finance.xbrl.dom.html/htmldivelement/
---
## HTMLDivElement class

Klassen representerar en generisk blockbehållare. Se DIV-elementdefinitionen i HTML 4.01.
