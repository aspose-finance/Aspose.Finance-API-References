...
description: Klassen representerar definition av bildkartområde på klientsidan. Se AREAelementdefinitionen i HTML 4.01.
type: docs
weight: 6720
url: /sv/net/aspose.finance.xbrl.dom.html/htmlareaelement/
---
## HTMLAreaElement class

Klassen representerar definition av bildkartområde på klientsidan. Se AREA-elementdefinitionen i HTML 4.01.
