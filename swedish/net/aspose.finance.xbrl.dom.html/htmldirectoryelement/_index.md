...
description: Klassen representerar kataloglistan. Se DIRelementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
type: docs
weight: 6810
url: /sv/net/aspose.finance.xbrl.dom.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Klassen representerar kataloglistan. Se DIR-elementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
