...
description: Klassen representerar formulärkontroll. Beroende på i vilken miljö sidan visas kan värdeegenskapen vara skrivskyddad för inmatningstypen för filuppladdning. För inmatningstypen lösenord kan det faktiska värdet som returneras maskeras för att förhindra obehörig användning. Se INPUTelementdefinitionen i HTML 4.01.
type: docs
weight: 6950
url: /sv/net/aspose.finance.xbrl.dom.html/htmlinputelement/
---
