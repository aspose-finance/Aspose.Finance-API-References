...
description: Klassen representerar generiska inbäddade objekt. I princip är alla egenskaper på objektelementet lässkriva men i vissa miljöer kan vissa egenskaper vara skrivskyddade när det underliggande objektet instansierats. Se OBJECTelementdefinitionen i HTML 4.01.
type: docs
weight: 7070
url: /sv/net/aspose.finance.xbrl.dom.html/htmlobjectelement/
---
## HTMLObjectElement class

Klassen representerar generiska inbäddade objekt. I princip är alla egenskaper på objektelementet läs-skriva men i vissa miljöer kan vissa egenskaper vara skrivskyddade när det underliggande objektet instansierats. Se OBJECT-elementdefinitionen i HTML 4.01.
