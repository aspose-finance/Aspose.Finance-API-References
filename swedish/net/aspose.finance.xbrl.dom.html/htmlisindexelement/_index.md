...
description: Denna klass används för textinmatning på en rad. Se ISINDEXelementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
type: docs
weight: 6960
url: /sv/net/aspose.finance.xbrl.dom.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Denna klass används för textinmatning på en rad. Se ISINDEX-elementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
