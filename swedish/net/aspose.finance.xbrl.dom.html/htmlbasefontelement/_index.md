...
description: Klassen representerar bastypsnitt. Se BASEFONTelementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
type: docs
weight: 6750
url: /sv/net/aspose.finance.xbrl.dom.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Klassen representerar bastypsnitt. Se BASEFONT-elementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
