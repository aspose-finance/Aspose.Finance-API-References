...
description: Klassen specificerar en länk till en extern resurs och definierar detta dokuments relation till den resursen eller vice versa. Se LINKelementdefinitionen i HTML 4.01
type: docs
weight: 7000
url: /sv/net/aspose.finance.xbrl.dom.html/htmllinkelement/
---
## HTMLLinkElement class

Klassen specificerar en länk till en extern resurs och definierar detta dokuments relation till den resursen (eller vice versa). Se LINK-elementdefinitionen i HTML 4.01
