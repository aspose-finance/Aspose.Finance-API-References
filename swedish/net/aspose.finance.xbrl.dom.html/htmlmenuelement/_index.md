...
description: Klassen representerar menylistan. Se MENUelementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
type: docs
weight: 7020
url: /sv/net/aspose.finance.xbrl.dom.html/htmlmenuelement/
---
## HTMLMenuElement class

Klassen representerar menylistan. Se MENU-elementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
