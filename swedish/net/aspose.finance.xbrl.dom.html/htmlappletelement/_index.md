...
description: Klassen representerar en inbäddad Javaapplet. Se APPLETelementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
type: docs
weight: 6710
url: /sv/net/aspose.finance.xbrl.dom.html/htmlappletelement/
---
## HTMLAppletElement class

Klassen representerar en inbäddad Java-applet. Se APPLET-elementdefinitionen i HTML 4.01. Detta element är föråldrat i HTML 4.01.
