...
description: Klassen representerar meddelande om ändring av en del av ett dokument. Se INS och DELelementdefinitionerna i HTML 4.01.
type: docs
weight: 7040
url: /sv/net/aspose.finance.xbrl.dom.html/htmlmodelement/
---
## HTMLModElement class

Klassen representerar meddelande om ändring av en del av ett dokument. Se INS- och DEL-elementdefinitionerna i HTML 4.01.
