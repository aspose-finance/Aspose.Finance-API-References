...
description: Klassen omfattar beteenden som liknar en samling och ett element. Det ger direkt åtkomst till de inneslutna formulärkontrollerna såväl som attributen för formulärelementet. Se FORMelementdefinitionen i HTML 4.01.
type: docs
weight: 6860
url: /sv/net/aspose.finance.xbrl.dom.html/htmlformelement/
---
## HTMLFormElement class

Klassen omfattar beteenden som liknar en samling och ett element. Det ger direkt åtkomst till de inneslutna formulärkontrollerna såväl som attributen för formulärelementet. Se FORM-elementdefinitionen i HTML 4.01.
