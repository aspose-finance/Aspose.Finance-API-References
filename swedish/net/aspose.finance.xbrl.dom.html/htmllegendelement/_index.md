...
description: Klassen representerar en bildtext för en FIELDSETgruppering. Se LEGENDelementdefinitionen i HTML 4.01.
type: docs
weight: 6990
url: /sv/net/aspose.finance.xbrl.dom.html/htmllegendelement/
---
## HTMLLegendElement class

Klassen representerar en bildtext för en FIELDSET-gruppering. Se LEGEND-elementdefinitionen i HTML 4.01.
