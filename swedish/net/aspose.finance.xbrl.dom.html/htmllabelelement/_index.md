...
description: Klassen representerar formulärfältets etiketttext. Se LABELelementdefinitionen i HTML 4.01.
type: docs
weight: 6980
url: /sv/net/aspose.finance.xbrl.dom.html/htmllabelelement/
---
## HTMLLabelElement class

Klassen representerar formulärfältets etiketttext. Se LABEL-elementdefinitionen i HTML 4.01.
