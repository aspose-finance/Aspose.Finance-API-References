...
description: Klassen representerar förformaterad text. Se PREelementdefinitionen i HTML 4.01.
type: docs
weight: 7120
url: /sv/net/aspose.finance.xbrl.dom.html/htmlpreelement/
---
## HTMLPreElement class

Klassen representerar förformaterad text. Se PRE-elementdefinitionen i HTML 4.01.
