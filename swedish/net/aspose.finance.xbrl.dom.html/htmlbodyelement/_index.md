...
description: Klassen representerar HTMLdokumentets brödtext. Detta element finns alltid i DOM API även om taggarna inte finns i källdokumentet. Se BODYelementdefinitionen i HTML 4.01.
type: docs
weight: 6760
url: /sv/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

Klassen representerar HTML-dokumentets brödtext. Detta element finns alltid i DOM API, även om taggarna inte finns i källdokumentet. Se BODY-elementdefinitionen i HTML 4.01.
