...
type: docs
weight: 20
url: /sv/net/aspose.finance/license/setlicense/
---
...
2. Den aktuella arbetskatalogen för java-applikationen.

3. Mappen som innehåller JAR-filen för Aspose-komponenten.

4. Mappen som innehåller klientens anropande JAR-fil.
...
* namnutrymme [Aspose.Finance](../../license)
