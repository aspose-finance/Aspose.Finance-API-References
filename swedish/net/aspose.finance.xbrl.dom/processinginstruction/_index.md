...
description: Klassen representerar en bearbetningsinstruktion som används i XML som ett sätt att behålla processorspecifik information i dokumentets text.
type: docs
weight: 7450
url: /sv/net/aspose.finance.xbrl.dom/processinginstruction/
---
## ProcessingInstruction class

Klassen representerar en "bearbetningsinstruktion", som används i XML som ett sätt att behålla processorspecifik information i dokumentets text.
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename) { get; } | Hämtar namnet på denna bearbetningsinstruktion. |
