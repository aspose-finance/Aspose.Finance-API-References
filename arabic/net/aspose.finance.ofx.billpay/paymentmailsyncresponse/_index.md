...
| الاسم | الوصف |
| --- | --- |
| [PaymentMailSyncResponse](paymentmailsyncresponse)() | إنشاء نسخة جديدة من الفئة [`PaymentMailSyncResponse`](../paymentmailsyncresponse) class. |
...
| [OfxExtension](../../aspose.finance.ofx.billpay/paymentmailsyncresponse/ofxextension) { get; set; } | الحصول أو تعيين [`OfxExtensionType`](../../aspose.finance.ofx/ofxextensiontype). |
| [PaymentMailTransactionResponses](../../aspose.finance.ofx.billpay/paymentmailsyncresponse/paymentmailtransactionresponses) { get; set; } | الحصول أو تعيين مجموعة من [`PaymentMailTransactionResponse`](../paymentmailtransactionresponse). |
