...
| الاسم | الوصف |
| --- | --- |
| [Commission](../../aspose.finance.ofx.investment/investmentsell/commission) { get; set; } | يحصل أو يضبط عمولة المعاملة. |
| [Currency](../../aspose.finance.ofx.investment/investmentsell/currency) { get; set; } | يحصل أو يضبط الـ [`Currency`](./currency). |
| [Fees](../../aspose.finance.ofx.investment/investmentsell/fees) { get; set; } | يحصل أو يضبط الرسوم المطبقة على الصفقة. |
| [Gain](../../aspose.finance.ofx.investment/investmentsell/gain) { get; set; } | يحصل أو يعيّن إجمالي الربح. |
| [Investment401kSource](../../aspose.finance.ofx.investment/investmentsell/investment401ksource) { get; set; } | يحصل أو يضبط مصدر المال لهذه المعاملة. |
...
| [TaxExempt](../../aspose.finance.ofx.investment/investmentsell/taxexempt) { get; set; } | يحصل أو يعيّن ما إذا كانت المعاملة معفاة من الضرائب. |
| [Total](../../aspose.finance.ofx.investment/investmentsell/total) { get; set; } | يحصل أو يعيّن إجمالي المعاملة. |
| [UnitPrice](../../aspose.finance.ofx.investment/investmentsell/unitprice) { get; set; } | يحصل أو يعيّن السعر لكل وحدة تُقتبس عادةً. لا يشمل markup/markdown. سعر السهم للأسهم، الصناديق المشتركة، وغيرها. نسبة القيمة الاسمية للسندات. لكل سهم (ليس عقد) للخيارات. |
| [Units](../../aspose.finance.ofx.investment/investmentsell/units) { get; set; } | يحصل أو يعيّن الوحدات. لإجراءات قائمة على الأوراق المالية غير تقسيم الأسهم. الأسهم للأسهم، الصناديق المشتركة، وغيرها. القيمة الاسمية للسندات. العقود للخيارات. |
| [Withholding](../../aspose.finance.ofx.investment/investmentsell/withholding) { get; set; } | يحصل أو يعيّن استقطاعات الضريبة الفيدرالية. |
