...
| الاسم | الوصف |
| --- | --- |
| [BankMailSyncResponse](bankmailsyncresponse)() | ينشئ مثيلاً جديداً من الفئة [`BankMailSyncResponse`](../bankmailsyncresponse). |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [AccountFrom](../../aspose.finance.ofx.bank/bankmailsyncresponse/accountfrom) { get; set; } | يحصل أو يضبط الـ from لـ [`BankAccount`](../../aspose.finance.ofx/bankaccount) أو [`CreditCardAccount`](../../aspose.finance.ofx/creditcardaccount). |
| [BankMailTransactionResponses](../../aspose.finance.ofx.bank/bankmailsyncresponse/bankmailtransactionresponses) { get; set; } | يحصل أو يضبط مجموعة الـ [`BankMailTransactionResponse`](../bankmailtransactionresponse). |
...
| [OfxExtension](../../aspose.finance.ofx.bank/bankmailsyncresponse/ofxextension) { get; set; } | الحصول أو تعيين [`OfxExtensionType`](../../aspose.finance.ofx/ofxextensiontype). |
