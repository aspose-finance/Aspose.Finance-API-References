...
description: Aspose.Finance.Xbrl.Dom.CharacterData τάξη. Το CharacterData επεκτείνει τον κόμβο με ένα σύνολο χαρακτηριστικών και μεθόδων για την πρόσβαση σε δεδομένα χαρακτήρων στο DOM.
type: docs
weight: 6670
url: /el/net/aspose.finance.xbrl.dom/characterdata/
---
## CharacterData class
