...
description: Aspose.Finance.Xbrl.Dom.Comment τάξη. Κληρονομεί από το CharacterData και αντιπροσωπεύει το περιεχόμενο ενός σχολίου.
type: docs
weight: 6680
url: /el/net/aspose.finance.xbrl.dom/comment/
---
## Comment class

Κληρονομεί από το CharacterData και αντιπροσωπεύει το περιεχόμενο ενός σχολίου.
...
| override [NodeName](../../aspose.finance.xbrl.dom/comment/nodename/) { get; } | Λαμβάνει το όνομα κόμβου του σχολίου. |
