...
description: Aspose.Finance.Xbrl.Dom.ProcessingInstruction τάξη. Η κλάση αντιπροσωπεύει μια εντολή επεξεργασίας που χρησιμοποιείται στην XML ως ένας τρόπος για να διατηρούνται πληροφορίες για τον επεξεργαστή στο κείμενο του εγγράφου.
type: docs
weight: 7480
url: /el/net/aspose.finance.xbrl.dom/processinginstruction/
---
## ProcessingInstruction class

Η κλάση αντιπροσωπεύει μια "εντολή επεξεργασίας", που χρησιμοποιείται στην XML ως ένας τρόπος για να διατηρούνται πληροφορίες για τον επεξεργαστή στο κείμενο του εγγράφου.
...
| override [NodeName](../../aspose.finance.xbrl.dom/processinginstruction/nodename/) { get; } | Παίρνει το όνομα αυτής της εντολής επεξεργασίας. |
