...
description: Aspose.Finance.Xbrl.PresentationLinkbaseRef τάξη. Αυτή η κλάση χρησιμοποιείται για την παρουσίαση αναφοράς βάσης συνδέσμων.
type: docs
weight: 7930
url: /el/net/aspose.finance.xbrl/presentationlinkbaseref/
---
## PresentationLinkbaseRef class

Αυτή η κλάση χρησιμοποιείται για την παρουσίαση αναφοράς βάσης συνδέσμων.
...
| [Links](../../aspose.finance.xbrl/presentationlinkbaseref/links/) { get; } | Λαμβάνει τη συλλογή του[`PresentationLink`](../presentationlink/) . |
