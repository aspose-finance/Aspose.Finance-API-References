...
description: Aspose.Finance.Xbrl.ReferenceLinkbaseRef τάξη. Αυτή η κλάση χρησιμοποιείται για την αναφορά αναφοράς βάσης συνδέσμων.
type: docs
weight: 7980
url: /el/net/aspose.finance.xbrl/referencelinkbaseref/
---
## ReferenceLinkbaseRef class

Αυτή η κλάση χρησιμοποιείται για την αναφορά αναφοράς βάσης συνδέσμων.
...
| [Links](../../aspose.finance.xbrl/referencelinkbaseref/links/) { get; } | Λαμβάνει τη συλλογή του[`ReferenceLink`](../referencelink/) . |
