...
description: OfxRequestDocument μέθοδος. Δημιουργεί και αποθηκεύει το αρχείο OFX στο δίσκο.
type: docs
weight: 200
url: /el/net/aspose.finance.ofx/ofxrequestdocument/save/
---
## Save(string, OfxVersionEnum) {#save_2}

Δημιουργεί και αποθηκεύει το αρχείο OFX στο δίσκο.
...
| --- | --- | --- |
| fileName | String | Το όνομα του αρχείου που δημιουργήθηκε. |
| ofxVersion | OfxVersionEnum | Η έκδοση ofx. |
...
Αποθηκεύει το αρχείο OFX στη ροή.
...
Δημιουργεί και αποθηκεύει το αρχείο OFX στη ροή.
