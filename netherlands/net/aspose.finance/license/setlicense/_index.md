...
type: docs
weight: 20
url: /nl/net/aspose.finance/license/setlicense/
---
...
2. De huidige werkmap van de Java-toepassing.

3. De map die het JAR-bestand van de Aspose-component bevat.

4. De map die het aanroepende JAR-bestand van de client bevat.
...
* class [License](../)
* naamruimte [Aspose.Finance](../../license/)
