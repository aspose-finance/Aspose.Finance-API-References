...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLModElement klas. De klasse vertegenwoordigt een bericht van wijziging van een deel van een document. Zie de INS en DELelementdefinities in HTML 4.01.
type: docs
weight: 7070
url: /nl/net/aspose.finance.xbrl.dom.html/htmlmodelement/
---
## HTMLModElement class

De klasse vertegenwoordigt een bericht van wijziging van een deel van een document. Zie de INS- en DEL-elementdefinities in HTML 4.01.
