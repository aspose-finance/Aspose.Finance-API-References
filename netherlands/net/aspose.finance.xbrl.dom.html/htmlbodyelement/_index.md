...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBodyElement klas. De klasse vertegenwoordigt de hoofdtekst van het HTMLdocument. Dit element is altijd aanwezig in de DOM API zelfs als de tags niet aanwezig zijn in het brondocument. Zie de BODYelementdefinitie in HTML 4.01.
type: docs
weight: 6790
url: /nl/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

De klasse vertegenwoordigt de hoofdtekst van het HTML-document. Dit element is altijd aanwezig in de DOM API, zelfs als de tags niet aanwezig zijn in het brondocument. Zie de BODY-elementdefinitie in HTML 4.01.
