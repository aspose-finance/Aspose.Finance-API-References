...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLObjectElement klas. De klasse vertegenwoordigt een generiek ingebed object. In principe zijn alle eigenschappen van het objectelement lezenschrijven maar in sommige omgevingen kunnen sommige eigenschappen alleenlezen zijn zodra het onderliggende object is geïnstantieerd. Zie de OBJECTelementdefinitie in HTML 4.01.
type: docs
weight: 7100
url: /nl/net/aspose.finance.xbrl.dom.html/htmlobjectelement/
---
## HTMLObjectElement class

De klasse vertegenwoordigt een generiek ingebed object. In principe zijn alle eigenschappen van het objectelement lezen-schrijven, maar in sommige omgevingen kunnen sommige eigenschappen alleen-lezen zijn zodra het onderliggende object is geïnstantieerd. Zie de OBJECT-elementdefinitie in HTML 4.01.
