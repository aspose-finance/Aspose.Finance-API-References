...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFormElement klas. De klasse omvat gedrag dat vergelijkbaar is met een verzameling en een element. Het biedt directe toegang tot de formulierbesturingselementen en de attributen van het formulierelement. Zie de definitie van het FORMelement in HTML 4.01.
type: docs
weight: 6890
url: /nl/net/aspose.finance.xbrl.dom.html/htmlformelement/
---
## HTMLFormElement class

De klasse omvat gedrag dat vergelijkbaar is met een verzameling en een element. Het biedt directe toegang tot de formulierbesturingselementen en de attributen van het formulierelement. Zie de definitie van het FORM-element in HTML 4.01.
