...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLFontElement klas. De klasse vertegenwoordigt een lokale wijziging van het lettertype. Zie de FONTelementdefinitie in HTML 4.01. Dit element is verouderd in HTML 4.01.
type: docs
weight: 6880
url: /nl/net/aspose.finance.xbrl.dom.html/htmlfontelement/
---
## HTMLFontElement class

De klasse vertegenwoordigt een lokale wijziging van het lettertype. Zie de FONT-elementdefinitie in HTML 4.01. Dit element is verouderd in HTML 4.01.
