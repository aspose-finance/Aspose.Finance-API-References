...
description: The class represents form control. Depending upon the environment in which the page is being viewed the value property may be read-only for the file upload input type. For the password input type the actual value returned may be masked to prevent unauthorized use. See the INPUT element definition in HTML 4.01.
type: docs
weight: 6950
...
| [ClassName](../../aspose.finance.xbrl.dom.html/htmlelement/classname) { get; set; } | Gets or sets the class attribute of the element. This attribute has been renamed due to conflicts with the "class" keyword exposed by many languages. See the class attribute definition in HTML 4.01. |
| [Dir](../../aspose.finance.xbrl.dom.html/htmlelement/dir) { get; set; } | Gets or sets the base direction of directionally neutral text and the directionality of tables. See the dir attribute definition in HTML 4.01. |
...
| [Id](../../aspose.finance.xbrl.dom.html/htmlelement/id) { get; set; } | Gets or sets the element's identifier. See the id attribute definition in HTML 4.01. |
| [Lang](../../aspose.finance.xbrl.dom.html/htmlelement/lang) { get; set; } | Gets or sets the language code defined in RFC 1766. See the lang attribute definition in HTML 4.01. |
...
| [Title](../../aspose.finance.xbrl.dom.html/htmlelement/title) { get; set; } | Gets or sets the element's advisory title. See the title attribute definition in HTML 4.01. |
