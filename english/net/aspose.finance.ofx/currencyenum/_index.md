...
| GBP | `45` | Pound sterling |
| GEL | `46` | Georgian lari |
| GHS | `47` | Ghanaian cedi |
| GIP | `48` | Gibraltar pound |
| GMD | `49` | Gambian dalasi |
| GNF | `50` | Guinean franc |
| GTQ | `51` | Guatemalan quetzal |
| GYD | `52` | Guyanese dollar |
| HKD | `53` | Hong Kong dollar |
| HNL | `54` | Honduran lempira |
...
| XPF | `155` | CFP franc |
| XPT | `156` | Platinum (one troy ounce) |
| YER | `157` | Yemeni rial |
| ZAR | `158` | South African rand |
| ZWL | `159` | Zimbabwe dollar |
| ZMW | `160` | Zambian kwacha |
