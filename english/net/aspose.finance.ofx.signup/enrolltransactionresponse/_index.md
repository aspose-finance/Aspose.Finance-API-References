...
| [EnrollResponse](../../aspose.finance.ofx.signup/enrolltransactionresponse/enrollresponse) { get; set; } | Gets or sets the [`EnrollResponse`](./enrollresponse). |
| [OfxExtension](../../aspose.finance.ofx.signup/enrolltransactionresponse/ofxextension) { get; set; } | Gets or sets the [`OfxExtensionType`](../../aspose.finance.ofx/ofxextensiontype). |
