...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLElement kelas. Semua kelas elemen HTML diturunkan dari kelas ini. Elemen yang hanya mengekspos atribut inti HTML diwakili oleh kelas ini elemen tersebut adalah sebagai berikut khusus SUB SUP SPAN BDOfont TT I B U S STRIKE BESAR KECIL frase EM KUAT  DFN CODE SAMP KBD VAR CITE ACRONYM ABBR daftar DD DTNOFRAMES NOSCRIPTADDRESS CENTERT.
type: docs
weight: 6860
url: /id/net/aspose.finance.xbrl.dom.html/htmlelement/
---
## HTMLElement class

Semua kelas elemen HTML diturunkan dari kelas ini. Elemen yang hanya mengekspos atribut inti HTML diwakili oleh kelas ini, elemen tersebut adalah sebagai berikut: khusus: SUB, SUP, SPAN, BDOfont: TT, I, B, U, S, STRIKE, BESAR, KECIL frase: EM, KUAT , DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR daftar: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTERT.
