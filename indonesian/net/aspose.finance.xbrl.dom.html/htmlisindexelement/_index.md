...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLIsIndexElement kelas. Kelas ini digunakan untuk input teks satu baris. Lihat definisi elemen ISINDEX di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
type: docs
weight: 6990
url: /id/net/aspose.finance.xbrl.dom.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Kelas ini digunakan untuk input teks satu baris. Lihat definisi elemen ISINDEX di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
