...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLInputElement kelas. Kelas mewakili kontrol formulir. Bergantung pada lingkungan tempat halaman dilihat properti value mungkin hanyabaca untuk jenis input unggahan file. Untuk jenis masukan sandi nilai aktual yang dikembalikan mungkin disamarkan untuk mencegah penggunaan yang tidak sah. Lihat definisi elemen INPUT di HTML 4.01.
type: docs
weight: 6980
url: /id/net/aspose.finance.xbrl.dom.html/htmlinputelement/
---
## HTMLInputElement class

Kelas mewakili kontrol formulir. Bergantung pada lingkungan tempat halaman dilihat, properti value mungkin hanya-baca untuk jenis input unggahan file. Untuk jenis masukan "sandi", nilai aktual yang dikembalikan mungkin disamarkan untuk mencegah penggunaan yang tidak sah. Lihat definisi elemen INPUT di HTML 4.01.
