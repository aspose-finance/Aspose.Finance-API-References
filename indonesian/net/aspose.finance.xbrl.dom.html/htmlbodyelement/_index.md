...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLBodyElement kelas. Kelas mewakili badan dokumen HTML. Elemen ini selalu ada di DOM API meskipun tag tidak ada di dokumen sumber. Lihat definisi elemen BODY di HTML 4.01.
type: docs
weight: 6790
url: /id/net/aspose.finance.xbrl.dom.html/htmlbodyelement/
---
## HTMLBodyElement class

Kelas mewakili badan dokumen HTML. Elemen ini selalu ada di DOM API, meskipun tag tidak ada di dokumen sumber. Lihat definisi elemen BODY di HTML 4.01.
