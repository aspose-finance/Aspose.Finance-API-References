...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLSelectElement kelas. Kelas mewakili elemen pilih memungkinkan pemilihan opsi. Opsi yang ada dapat langsung diakses melalui elemen pilih sebagai koleksi. Lihat definisi elemen SELECT di HTML 4.01.
type: docs
weight: 7180
url: /id/net/aspose.finance.xbrl.dom.html/htmlselectelement/
---
## HTMLSelectElement class

Kelas mewakili elemen pilih memungkinkan pemilihan opsi. Opsi yang ada dapat langsung diakses melalui elemen pilih sebagai koleksi. Lihat definisi elemen SELECT di HTML 4.01.
