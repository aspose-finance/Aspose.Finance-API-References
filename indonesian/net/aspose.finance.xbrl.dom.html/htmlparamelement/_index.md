...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLParamElement kelas. Kelas mewakili parameter yang diumpankan ke elemen OBJECT. Lihat definisi elemen PARAM di HTML 4.01.
type: docs
weight: 7140
url: /id/net/aspose.finance.xbrl.dom.html/htmlparamelement/
---
## HTMLParamElement class

Kelas mewakili parameter yang diumpankan ke elemen OBJECT. Lihat definisi elemen PARAM di HTML 4.01.
