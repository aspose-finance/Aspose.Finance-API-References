...
description: Aspose.Finance.Xbrl.Dom.Html.HTMLLinkElement kelas. Kelas menentukan tautan ke sumber daya eksternal dan menentukan hubungan dokumen ini dengan sumber daya tersebut atau sebaliknya. Lihat definisi elemen LINK di HTML 4.01
type: docs
weight: 7030
url: /id/net/aspose.finance.xbrl.dom.html/htmllinkelement/
---
## HTMLLinkElement class

Kelas menentukan tautan ke sumber daya eksternal, dan menentukan hubungan dokumen ini dengan sumber daya tersebut (atau sebaliknya). Lihat definisi elemen LINK di HTML 4.01
