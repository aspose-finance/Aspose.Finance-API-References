...
description: Aspose.Finance.Xbrl.DefinitionArc kelas. Kelas ini adalah aXlink dengan tipe Arc. Mendefinisikan berbagai jenis hubungan antar Konsep.
type: docs
weight: 6620
url: /id/net/aspose.finance.xbrl/definitionarc/
---
## DefinitionArc class

Kelas ini adalah a[`Xlink`](../xlink/) dengan tipe Arc. Mendefinisikan berbagai jenis hubungan antar Konsep.
...
| Nama | Keterangan |
| --- | --- |
| [GetFromLocs](../../aspose.finance.xbrl/definitionarc/getfromlocs/)() | Mendapat koleksi dari[`Loc`](../loc/) dalam`DefinitionArc` . |
| [GetToLocs](../../aspose.finance.xbrl/definitionarc/gettolocs/)() | Mendapat koleksi dari to[`Loc`](../loc/) dalam`DefinitionArc` . |
